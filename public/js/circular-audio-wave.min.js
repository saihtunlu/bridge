        ...
        series: [
          {
            ...
            lineStyle: {
              color: {
                colorStops: [
                  { offset: 0.7, color:  `rgba(${this.Color},1)` },
                  { offset: 0.3, color:  `rgba(${this.Color},1)` },
                ],
              },
              shadowColor:  `rgba(${this.Color},1)`,
              shadowBlur: 10,
            },
            zlevel: 2,
          ...
          },
          {
            ...
            data: [0],
            symbolSize: 100,
            rippleEffect: { period: 3.5, scale: 2.5 },
            itemStyle: {
              color: {
                type: "radial",
                colorStops: [
                  { offset: 0, color:  `rgba(${this.Color},1)` },
                  { offset: 1, color: `rgba(${this.Color},0.5)` },
                ],
              },
            },
            silent: !0,
