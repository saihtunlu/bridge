!(function(t, e) {
  ...
  var e = 2311,
    ...
    n =
      "object" == typeof wx && "function" == typeof wx.getSystemInfoSync
        ...
        ? { browser: {}, os: {}, node: !1, worker: !0, canvasSupported: !0 }
  ...
  function w(t, e) {
    var i = t.prototype;
    function n() {}
    for (var r in ((n.prototype = e.prototype), (t.prototype = new n()), i))
      t.prototype[r] = i[r];
  ...
  Y.prototype = {
    ...
    each: function(t, e) {
      for (var i in (void 0 !== e && (t = C(t, e)), this))
  ...
  ht.prototype = {
    ...
    _dragStart: function(t) {
      ...
      e &&
        ...
        (this._x = t.offsetX),
        (this._y = t.offsetY),
        this.dispatchToElement(ut(e, t), "dragstart", t.event));
    },
    _drag: function(t) {
      ...
      if (e) {
        ...
        (this._x = i),
          (this._y = n),
          e.drift(r, a, t),
          this.dispatchToElement(ut(e, t), "drag", t.event);
        ...
        (this._dropTarget = o),
          e !== o &&
            (s &&
              o !== s &&
              this.dispatchToElement(ut(s, t), "dragleave", t.event),
            o &&
              o !== s &&
              this.dispatchToElement(ut(o, t), "dragenter", t.event));
      }
    },
    _dragEnd: function(t) {
      var e = this._draggingTarget;
      e && (e.dragging = !1),
        this.dispatchToElement(ut(e, t), "dragend", t.event),
        this._dropTarget &&
          this.dispatchToElement(ut(this._dropTarget, t), "drop", t.event),
  ...
  dt.prototype = {
    ...
    triggerWithContext: function(t) {
      if (this._$handlers[t]) {
        ...
        for (
          var n = e[e.length - 1], r = this._$handlers[t], a = r.length, o = 0;
          o < a;
    ...
    findHover: function(t, e, i) {
      for (
        ...
        if (
          ...
          !n[a].ignore &&
          (o = mt(n[a], t, e)) &&
          (!r.topTarget && (r.topTarget = n[a]), o !== ft)
        ) {
          r.target = n[a];
          break;
        }
        ...
        vt.prototype[t] = function(e) {
          ...
          if ("mousedown" === t)
            ...
            if (
              ...
              !this._downPoint ||
              rt(this._downPoint, [e.zrX, e.zrY]) > 4
            )
              return;
  ...
  var kt = function(t) {
    ...
    Pt = kt.prototype;
  (Pt.transform = null),
    (Pt.needLocalTransform = function() {
      return (
        Dt(this.rotation) ||
        Dt(this.position[0]) ||
        Dt(this.position[1]) ||
    ...
    (Pt.updateTransform = function() {
      ...
      i || e
        ? ((n = n || xt()),
          i ? this.getLocalTransform(n) : Ct(n),
          e && (i ? bt(n, t.transform, n) : wt(n, t.transform)),
          (this.transform = n),
          (this.invTransform = this.invTransform || xt()),
          It(this.invTransform, n))
        : n && Ct(n);
    }),
  ...
  function $t(t, e) {
    if (t) {
      ...
      if ("#" === r.charAt(0))
        return 4 === r.length
          ? (n = parseInt(r.substr(1), 16)) >= 0 && n <= 4095
            ? (Ut(
                e,
                ((3840 & n) >> 4) | ((3840 & n) >> 8),
                (240 & n) | ((240 & n) >> 4),
            ...
            : void Ut(e, 0, 0, 0, 1)
          : 7 === r.length
          ? (n = parseInt(r.substr(1), 16)) >= 0 && n <= 16777215
            ? (Ut(e, (16711680 & n) >> 16, (65280 & n) >> 8, 255 & n, 1),
              Kt(t, e),
              e)
            : void Ut(e, 0, 0, 0, 1)
          : void 0;
      ...
      if (-1 !== a && o + 1 === r.length) {
        ...
        switch (s) {
          ...
          case "rgb":
            return 3 !== l.length
              ? void Ut(e, 0, 0, 0, 1)
              : (Ut(e, Gt(l[0]), Gt(l[1]), Gt(l[2]), h), Kt(t, e), e);
          case "hsla":
            return 4 !== l.length
              ? void Ut(e, 0, 0, 0, 1)
              : ((l[3] = qt(l[3])), Qt(l, e), Kt(t, e), e);
          case "hsl":
            return 3 !== l.length
              ? void Ut(e, 0, 0, 0, 1)
              : (Qt(l, e), Kt(t, e), e);
  ...
  function ae(t, e, i, n, r) {
    var a = t.length;
    if (1 == r) for (var o = 0; o < a; o++) n[o] = ne(t[o], e[o], i);
    else {
      var s = a && t[0].length;
      for (o = 0; o < a; o++)
  ...
  function oe(t, e, i) {
    ...
    if (n !== r)
      if (n > r) t.length = r;
      else for (var a = n; a < r; a++) t.push(1 === i ? e[a] : te.call(e[a]));
  ...
  function se(t, e, i) {
    ...
    if (1 === i) {
      ...
      var a = t[0].length;
      for (r = 0; r < n; r++)
        for (var o = 0; o < a; o++) if (t[r][o] !== e[r][o]) return !1;
    }
    return !0;
  }
  function le(t, e, i, n, r, a, o, s, l) {
    ...
    if (1 == l)
      ...
      for (u = 0; u < h; u++)
        for (var d = 0; d < c; d++)
          s[u][d] = he(t[u][d], e[u][d], i[u][d], n[u][d], r, a, o);
    }
  }
  ...
  function de(t, e, i, n, r, a) {
    ...
    if (h) {
      ...
      if (a || !y) {
        var b = v[h - 1];
        for (x = 0; x < h - 1; x++)
          c ? oe(v[x], b, p) : !isNaN(v[x]) || isNaN(b) || f || d || (v[x] = b);
            ...
            if (0 !== n)
              if (((S = (e - g[i]) / n), l))
                if (
                  ...
                  le(T, I, C, A, S, S * S, S * S * S, o(t, r), p);
                else {
                  if (d)
                    (a = le(T, I, C, A, S, S * S, S * S * S, P, 1)),
                      (a = ce(P));
                  else {
      ...
      for (var n in e)
        if (e.hasOwnProperty(n)) {
          if (!i[n]) {
            ...
            if (null == r) continue;
            0 !== t && i[n].push({ time: 0, value: ue(r) });
          }
  ...
  "undefined" != typeof window &&
    (pe = Math.max(window.devicePixelRatio || 1, 1));
  var ge = pe,
    ve = function() {};
  var me = ve,
    ye = function() {
    ...
    _animateToShallow: function(t, e, i, n, r) {
      ...
      for (var s in i)
        if (i.hasOwnProperty(s))
          if (null != e[s])
            L(i[s]) && !M(i[s])
              ? this._animateToShallow(t ? t + "." + s : s, e[s], i[s], n, r)
              : ((a[s] = i[s]), o++);
          else if (null != i[s])
            if (t) {
              var l = {};
  ...
  (Ce.prototype = {
    ...
    union: function(t) {
      var e = Te(t.x, this.x),
        i = Te(t.y, this.y);
      (this.width = Ie(t.x + t.width, this.x + this.width) - e),
        (this.height = Ie(t.y + t.height, this.y + this.height) - i),
        (this.x = e),
        (this.y = i);
    },
    applyTransform:
      ...
      function(t) {
        if (t) {
          (_e[0] = be[0] = this.x),
            (_e[1] = Me[1] = this.y),
            (we[0] = Me[0] = this.x + this.width),
            (we[1] = be[1] = this.y + this.height),
            Se(_e, _e, t),
            Se(we, we, t),
            Se(be, be, t),
            Se(Me, Me, t),
            (this.x = Te(_e[0], we[0], be[0], Me[0])),
            (this.y = Te(_e[1], we[1], be[1], Me[1]));
  ...
  (Ae.prototype = {
    ...
    _doAdd: function(t) {
      ...
      e &&
        e !== t.__storage &&
        (e.addToStorage(t), t instanceof Ae && t.addChildrenToStorage(e)),
        i && i.refresh();
    },
    remove: function(t) {
      var e = this.__zr,
      ...
      return r < 0
        ...
        : (n.splice(r, 1),
          ...
          i &&
            (i.delFromStorage(t),
            t instanceof Ae && t.delChildrenFromStorage(i)),
          e && e.refresh(),
          this);
    },
    removeAll: function() {
      ...
      for (e = 0; e < i.length; e++)
        (t = i[e]),
          n &&
            (n.delFromStorage(t),
            t instanceof Ae && t.delChildrenFromStorage(n)),
          (t.parent = null);
  ...
  function Ne(t, e) {
    ...
    function s(s) {
      var l = i[s],
        ...
        c = n[s + 1];
      (n[s] = h + c),
        s === a - 3 && ((i[s + 1] = i[s + 2]), (n[s + 1] = n[s + 2])),
        a--;
      var d = Ee(t[u], t, l, h, 0, e);
      (l += d),
        0 !== (h -= d) &&
          0 !== (c = Oe(t[l + h - 1], t, u, c, c - 1, e)) &&
          (h <= c
            ? (function(i, n, a, s) {
                var l = 0;
  ...
  ze.prototype = {
    ...
    updateDisplayList: function(t) {
      ...
      for (
        var e = this._roots, i = this._displayList, r = 0, a = e.length;
        r < a;
        r++
      )
    ...
    addRoot: function(t) {
      t.__storage !== this &&
        (t instanceof Ae && t.addChildrenToStorage(this),
        this.addToStorage(t),
        this._roots.push(t));
    },
    delRoot: function(t) {
      ...
      if (t instanceof Array) {
        ...
        r >= 0 &&
          ...
          t instanceof Ae && t.delChildrenFromStorage(this));
      }
    },
  ...
  function Ge(t, e, i) {
    ...
    return (
      ...
      (a = isNaN(a) ? 0 : a),
      (o = isNaN(o) ? 0 : o),
      t.createLinearGradient(n, a, r, o)
    );
  }
  function qe(t, e, i) {
    var n = i.width,
  ...
  We.prototype = {
    ...
    bind: function(t, e, i) {
      ...
      if (
        ((r || this.fill !== n.fill) && (t.fillStyle = this.fill),
        (r || this.stroke !== n.stroke) && (t.strokeStyle = this.stroke),
        (r || this.opacity !== n.opacity) &&
          (t.globalAlpha = null == this.opacity ? 1 : this.opacity),
        (r || this.blend !== n.blend) &&
    ...
    getGradient: function(t, e, i) {
      for (
        var n = ("radial" === e.type ? qe : Ge)(t, e, i),
          r = e.colorStops,
          a = 0;
        a < r.length;
        a++
  ...
  var $e = function(t, e, i) {
    var n;
    (i = i || ge),
      "string" == typeof t ? (n = Ke(t, e, i)) : L(t) && (t = (n = t).id),
      (this.id = t),
      (this.dom = n);
    var r = n.style;
    r &&
  ...
  $e.prototype = {
    ...
    createBackBuffer: function() {
      var t = this.dpr;
      (this.domBack = Ke("back-" + this.id, this.painter, t)),
    ...
    clear: function(t, e) {
      ...
      (s &&
        ...
        this.ctxBack.drawImage(n, 0, 0, a / h, o / h)),
      r.clearRect(0, 0, a, o),
      e && "transparent" !== e) &&
        (e.colorStops
          ? ((i =
              e.__canvasGradient ||
              We.getGradient(r, e, { x: 0, y: 0, width: a, height: o })),
            (e.__canvasGradient = i))
          : e.image && (i = Ze.prototype.getCanvasPattern.call(e, r)),
        r.save(),
        (r.fillStyle = i || e),
        r.fillRect(0, 0, a, o),
        r.restore());
  ...
  function ei(t, e, i, n, r) {
    if (t) {
      if ("string" == typeof t) {
        ...
        return (
          a
            ? !ni((e = a.image)) && a.pending.push(o)
            : (!e && (e = new Image()),
              (e.onload = ii),
              Je.put(t, (e.__cachedImgObj = { image: e, pending: [o] })),
  ...
  function vi(t, e) {
    ...
    for (var o = 0; ; o++) {
      ...
      var s =
        0 === o
          ? mi(t, r, e.ascCharWidth, e.cnCharWidth)
          : a > 0
  ...
  function _i(t, e, i, n) {
    ...
    if ((i && (s += i[0] + i[2]), t && n)) {
      ...
      if (null != l && s > l) (t = ""), (a = []);
        ...
        for (
          var u = gi(h - (i ? i[1] + i[3] : 0), e, n.ellipsis, {
              minChar: n.minChar,
  ...
  function wi(t, e) {
      ...
      for (var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
        ...
        if ("string" == typeof M && "%" === M.charAt(M.length - 1))
          ...
          null != A &&
            A < M &&
            (!S || A < C
              ? ((D.text = ""), (D.textWidth = M = 0))
              : ((D.text = pi(D.text, A - C, w, c.ellipsis, {
                  minChar: c.minChar,
                })),
                (D.textWidth = ui(D.text, w)),
                (M = D.textWidth + C)));
    ...
    (i.outerWidth = i.width = z(e.textWidth, l)),
      (i.outerHeight = i.height = z(e.textHeight, s)),
      u && ((i.outerWidth += u[1] + u[3]), (i.outerHeight += u[0] + u[2]));
    for (p = 0; p < h.length; p++) {
      var D,
        k = (D = h[p]).percentWidth;
    ...
    h < 0 && ((s += h), (h = -h)),
      ...
      "number" == typeof c
        ...
        ? 1 === c.length
          ...
          : 3 === c.length
          ? ((i = c[0]), (n = a = c[1]), (r = c[2]))
          : ((i = c[0]), (n = c[1]), (r = c[2]), (a = c[3]))
        : (i = n = r = a = 0),
      i + n > h && ((i *= h / (o = i + n)), (n *= h / o)),
      r + a > h && ((r *= h / (o = r + a)), (a *= h / o)),
      n + r > u && ((n *= u / (o = n + r)), (r *= u / o)),
      i + a > u && ((i *= u / (o = i + a)), (a *= u / o)),
      t.moveTo(s + i, l),
      t.lineTo(s + h - n, l),
      0 !== n && t.arc(s + h - n, l + n, n, -Math.PI / 2, 0),
      t.lineTo(s + h, l + u - r),
      0 !== r && t.arc(s + h - r, l + u - r, r, 0, Math.PI / 2),
      t.lineTo(s + a, l + u),
  ...
  var Si = { left: 1, right: 1, center: 1 },
    Ti = { top: 1, bottom: 1, middle: 1 };
  function Ii(t) {
  ...
  function Ci(t) {
    if (t) {
      ...
      var e = t.textAlign;
      "middle" === e && (e = "center"),
        (t.textAlign = null == e || Si[e] ? e : "left");
      var i = t.textVerticalAlign || t.textBaseline;
      "center" === i && (i = "middle"),
        (t.textVerticalAlign = null == i || Ti[i] ? i : "top"),
  ...
  function Ai(t, e, i, n, r) {
    n.rich
            ...
            for (var x = 0; x < i.lines.length; x++) {
              for (
                var _,
                  ...
                  A = y,
                  D = M - 1;
                I < M && (!(_ = b[I]).textAlign || "left" === _.textAlign);

              )
                ki(t, e, _, n, S, m, C, "left"),
                  (T -= _.width),
                  (C += _.width),
                  I++;
              for (; D >= 0 && "right" === (_ = b[D]).textAlign; )
                ki(t, e, _, n, S, m, A, "right"),
                  (T -= _.width),
                  (A -= _.width),
                  D--;
              for (C += (a - (C - v) - (y - A) - T) / 2; I <= D; )
                (_ = b[I]),
                  ki(t, e, _, n, S, m, C + _.width / 2, "center"),
                  (C += _.width),
                  I++;
              m += S;
            }
      ...
      : (function(t, e, i, n, r) {
          ...
          (s && !t.__dirty) ||
            (s = t.__textCotentBlock = _i(i, a, o, n.truncate));
          var l = s.outerHeight,
            h = s.lines,
            u = s.lineHeight,
            c = Ei(l, n, r),
          ...
          Ni(e, "textAlign", p || "left"),
            Ni(e, "textBaseline", "middle"),
            Ni(e, "shadowBlur", n.textShadowBlur || 0),
            Ni(e, "shadowColor", n.textShadowColor || "transparent"),
            Ni(e, "shadowOffsetX", n.textShadowOffsetX || 0),
            Ni(e, "shadowOffsetY", n.textShadowOffsetY || 0),
            (y += u / 2);
          ...
          for (var I = 0; I < h.length; I++)
            S && e.strokeText(h[I], m, y),
              T && e.fillText(h[I], m, y),
              (y += u);
        })(t, e, i, n, r);
  }
  ...
  function ki(t, e, i, n, r, a, o, s) {
    ...
    var c = i.textPadding;
    c && ((o = Fi(o, s, c)), (u -= i.height / 2 - c[2] - i.textHeight / 2)),
      Ni(e, "shadowBlur", F(l.textShadowBlur, n.textShadowBlur, 0)),
      Ni(
        e,
        "shadowColor",
        l.textShadowColor || n.textShadowColor || "transparent"
      ),
      Ni(e, "shadowOffsetX", F(l.textShadowOffsetX, n.textShadowOffsetX, 0)),
      Ni(e, "shadowOffsetY", F(l.textShadowOffsetY, n.textShadowOffsetY, 0)),
      Ni(e, "textAlign", s),
      Ni(e, "textBaseline", "middle"),
      Ni(e, "font", i.font || li);
    ...
    d &&
      ...
      f && (Ni(e, "fillStyle", f), e.fillText(i.text, o, u));
  }
  function Pi(t) {
  ...
  function Li(t, e, i, n, r, a, o) {
    var s = i.textBackgroundColor,
      ...
      u = P(s);
    if (
      (Ni(e, "shadowBlur", i.textBoxShadowBlur || 0),
      Ni(e, "shadowColor", i.textBoxShadowColor || "transparent"),
      Ni(e, "shadowOffsetX", i.textBoxShadowOffsetX || 0),
      Ni(e, "shadowOffsetY", i.textBoxShadowOffsetY || 0),
      u || (l && h))
    ) {
      e.beginPath();
      var c = i.textBorderRadius;
      c ? Mi(e, { x: n, y: r, width: a, height: o, r: c }) : e.rect(n, r, a, o),
        e.closePath();
    }
  ...
  function Ei(t, e, i) {
    ...
    if (i) {
      ...
      if (s instanceof Array)
        (n = i.x + zi(s[0], i.width)), (r = i.y + zi(s[1], i.height));
      else {
  ...
  function Gi(t) {
    ...
    (this.style = new We(t.style, this)),
      (this._rect = null),
      (this.__clipPaths = []);
  }
  function qi(t) {
  ...
  (Wi.prototype = {
    ...
    drawRectText: function(t, e) {
      ...
      if ((null != n && (n += ""), Vi(n, i))) {
        ...
        i.transformText
          ? this.setTransform(t)
          : r && (Hi.copy(e), Hi.applyTransform(r), (e = Hi)),
          Ai(this, t, n, i, e),
          t.restore();
      }
    },
  ...
  var Zi = function(t, e, i) {
    ...
    (this._opts = i = v({}, i || {})),
      (this.dpr = i.devicePixelRatio || ge),
      (this._singleCanvas = n),
      (this.root = t);
    var r = t.style;
    r &&
      ((r["-webkit-tap-highlight-color"] = "transparent"),
      (r["-webkit-user-select"] = r["user-select"] = r[
  ...
  Zi.prototype = {
    ...
    refreshHover: function() {
      var t = this._hoverElements,
        ...
        i = this._hoverlayer;
      if ((i && i.clear(), e)) {
        Re(t, this.storage.displayableSortFunc),
    ...
    _doPaintList: function(t, e) {
      ...
      for (var o = !0, s = 0; s < i.length; s++) {
        ...
        (l.__drawIndex = v),
          l.__drawIndex < l.__endIndex && (o = !1),
          u.prevElClipPaths && h.restore(),
          h.restore();
      }
      return (
        n.wxa &&
          S(this._layers, function(t) {
    ...
    _doPaintEl: function(t, e, i, n) {
      ...
      if (
        ...
        (!t.culling ||
          !(function(t, e, i) {
            return (
              Ui.copy(t.getBoundingRect()),
              t.transform && Ui.applyTransform(t.transform),
              (Yi.width = e),
              (Yi.height = i),
              !Ui.intersect(Yi)
            );
    ...
    getLayer: function(t, e) {
      ...
      return (
        i ||
          (((i = new $e("zr_" + t, this, this.dpr)).zlevel = t),
          (i.__builtin__ = !0),
          this._layerConfig[t] && g(i, this._layerConfig[t], !0),
          e && (i.virtual = e),
    ...
    eachBuiltinLayer: function(t, e) {
      ...
      for (r = 0; r < a.length; r++)
        (n = a[r]), (i = this._layers[n]).__builtin__ && t.call(e, i, n);
    },
    ...
    _updateLayerStatus: function(t) {
      ...
      for (i = 0; i < t.length; i++) {
        ...
        a.incremental
          ...
          o.__builtin__ ||
            me("ZLevel " + s + " has been used by unkown layer " + o.id),
          o !== n &&
            ((o.__used = !0),
    ...
    configLayer: function(t, e) {
      if (e) {
        ...
        for (var n = 0; n < this._zlevelList.length; n++) {
          ...
          if (r === t || r === t + 0.01) g(this._layers[r], i[t], !0);
        }
      }
    },
    delLayer: function(t) {
    ...
    resize: function(t, e) {
      if (this._domRoot.style) {
        ...
        if (
          ...
          for (var r in ((i.style.width = t + "px"),
          (i.style.height = e + "px"),
          this._layers))
    ...
    pathToImage: function(t, e) {
      ...
      (t.position = [u - r.x, d - r.y]),
        ...
        t.updateTransform(),
        t && t.brush(n);
      var m = new qi({ style: { x: 0, y: 0, image: i } });
      return (
  ...
  var on = {
    ...
    hn = { pointerdown: 1, pointerup: 1, pointermove: 1, pointerout: 1 },
    un = T(sn, function(t) {
  ...
  function dn(t, e, i) {
    ...
    if (("end" === i && n.clear(), r)) {
      var a = r.type;
      (e.gestureEvent = a),
        t.handler.dispatchToElement({ target: r.target }, a, r.event);
    }
  }
  function fn(t) {
    (t._touching = !0),
  ...
  var pn = {
    ...
    touchstart: function(t) {
      ((t = Ji(this.dom, t)).zrByTouch = !0),
        (this._lastTouchMoment = new Date()),
        dn(this, t, "start"),
        pn.mousemove.call(this, t),
    ...
    touchend: function(t) {
      ((t = Ji(this.dom, t)).zrByTouch = !0),
        ...
        +new Date() - this._lastTouchMoment < 300 && pn.click.call(this, t),
        fn(this);
    },
  ...
  function vn(t) {
    ...
    dt.call(this),
      ...
      n.pointerEventsSupported
        ? i(un, this)
        : (n.touchEventsSupported && i(ln, this), i(sn, this));
  }
  S(
  ...
  var wn = function(t, e, i) {
    ...
    (this.handler = new vt(a, s, l, s.root)),
      (this.animation = new nn({ stage: { update: C(this.flush, this) } })),
        ...
        if ("dataIndex" !== r && "dataIndexInside" !== r) {
          ...
          if (
            !(
              ...
              null == n ||
              ("index" === l && "none" === n) ||
              (i && i.includeMainTypes && _(i.includeMainTypes, s) < 0)
            )
          ) {
            var h = { mainType: s };
            ("index" === l && "all" === n) || (h[l] = n);
  ...
  function Hn(t) {
    var e = { main: "", sub: "" };
    return (
      t && ((t = t.split(Fn)), (e.main = t[0] || ""), (e.sub = t[1] || "")), e
    );
  }
  function Wn(t, e) {
    (t.$constructor = t),
  ...
  var Lr = { M: 1, L: 2, C: 3, Q: 4, A: 5, Z: 6, R: 7 },
    Or = [],
    Er = [],
    Nr = [],
    Rr = [],
  ...
  function Ur(t, e, i, n, r, a, o, s, l, h, u) {
    ...
    return (
      !(
        (u > e + c && u > n + c && u > a + c && u > s + c) ||
        (u < e - c && u < n - c && u < a - c && u < s - c) ||
        (h > t + c && h > i + c && h > r + c && h > o + c) ||
        (h < t - c && h < i - c && h < r - c && h < o - c)
      ) &&
      (function(t, e, i, n, r, a, o, s, l, h, u) {
        var c,
          d,
          f,
          p,
        ...
        for (var y = 0; y < 1; y += 0.05)
          (or[0] = ur(t, i, r, o, y)),
            (or[1] = ur(e, n, a, s, y)),
            (p = at(ar, or)) < m && ((c = y), (m = p));
        m = 1 / 0;
        for (var x = 0; x < 32 && !(v < ir); x++)
          (d = c - v),
            (f = c + v),
            (or[0] = ur(t, i, r, o, d)),
            (or[1] = ur(e, n, a, s, d)),
        ...
        return (
          u && ((u[0] = ur(t, i, r, o, c)), (u[1] = ur(e, n, a, s, c))), tr(m)
        );
      })(t, e, i, n, r, a, o, s, h, u, null) <=
        c / 2
    );
  }
  ...
  (qr.prototype = {
    ...
    lineTo: function(t, e) {
      var i =
        Wr(t - this._xi) > this._ux ||
        Wr(e - this._yi) > this._uy ||
        this._len < 5;
      return (
        this.addData(Lr.L, t, e),
        this._ctx &&
          i &&
          (this._needsDash()
    ...
    arc: function(t, e, i, n, r, a) {
      return (
        this.addData(Lr.A, t, e, i, i, n, r - n, 0, a ? 0 : 1),
    ...
    _dashedLineTo: function(t, e) {
      var i,
        ...
        g = o.length;
      for (
        a < 0 && (a = r + a), f -= (a %= r) * (u /= d), p -= a * (c /= d);
        (u > 0 && f <= t) ||
        (u < 0 && f >= t) ||
        (0 == u && ((c > 0 && p <= e) || (c < 0 && p >= e)));

      )
        (f += u * (i = o[(n = this._dashIdx)])),
          (p += c * i),
          (this._dashIdx = (n + 1) % g),
          (u > 0 && f < l) ||
            (u < 0 && f > l) ||
    ...
    toStatic: function() {
      var t = this.data;
      t instanceof Array &&
        ((t.length = this._len), Gr && (this.data = new Float32Array(t)));
    },
    getBoundingRect: function() {
      (Or[0] = Or[1] = Nr[0] = Nr[1] = Number.MAX_VALUE),
        (Er[0] = Er[1] = Rr[0] = Rr[1] = -Number.MAX_VALUE);
      for (
        ...
        switch ((1 == a && ((n = e = t[a]), (r = i = t[a + 1])), o)) {
          ...
          case Lr.L:
            ...
            break;
          case Lr.C:
            Dr(e, i, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], Nr, Rr),
              (e = t[a++]),
              (i = t[a++]);
            break;
          case Lr.Q:
            kr(e, i, t[a++], t[a++], t[a], t[a + 1], Nr, Rr),
              (e = t[a++]),
              (i = t[a++]);
            break;
          case Lr.A:
            var s = t[a++],
              ...
              d = t[a++] + c,
              f = (t[a++], 1 - t[a++]);
            1 == a && ((n = Fr(c) * h + s), (r = Vr(c) * u + l)),
              Pr(s, l, h, u, c, d, f, Nr, Rr),
              (e = Fr(d) * h + s),
              (i = Vr(d) * u + l);
            break;
          case Lr.R:
      ...
      return (
        0 === a && (Or[0] = Or[1] = Er[0] = Er[1] = 0),
        new Ce(Or[0], Or[1], Er[0] - Or[0], Er[1] - Or[1])
      );
    },
  ...
  function $r(t, e, i, n, r, a, o, s, l) {
    ...
    return (
      d < 0 && (d += Kr), (d >= n && d <= r) || (d + Kr >= n && d + Kr <= r)
    );
  }
      ...
      c = (function(t, e, i, n, r, a) {
        ...
        if (lr(u) && lr(c))
          ...
          if (lr(p)) {
            ...
            (S =
              (-s -
                ((y = y < 0 ? -Jn(-y, rr) : Jn(y, rr)) +
                  (x = x < 0 ? -Jn(-x, rr) : Jn(x, rr)))) /
              (3 * o)) >= 0 &&
              S <= 1 &&
              (a[f++] = S);
          } else {
            var _ = (2 * u * s - 3 * o * c) / (2 * tr(u * u * u)),
              ...
              S = (-s - 2 * b * M) / (3 * o),
              T =
                ((v = (-s + b * (M + nr * Math.sin(w))) / (3 * o)),
                (-s + b * (M - nr * Math.sin(w))) / (3 * o));
            S >= 0 && S <= 1 && (a[f++] = S),
              v >= 0 && v <= 1 && (a[f++] = v),
              T >= 0 && T <= 1 && (a[f++] = T);
          }
    ...
    for (var d, f, p = 0, g = -1, v = 0; v < c; v++) {
      ...
      ur(t, i, r, o, m) < l ||
        (g < 0 &&
          ...
          na[1] < na[0] &&
            g > 1 &&
            (void 0, (u = na[0]), (na[0] = na[1]), (na[1] = u)),
          (d = ur(e, n, a, s, na[0])),
          g > 1 && (f = ur(e, n, a, s, na[1]))),
        2 == g
          ? m < na[0]
            ? (p += d < e ? y : -y)
            : m < na[1]
  ...
  function aa(t, e, i, n, r, a, o, s) {
    ...
    if (h >= 0 && h <= 1) {
      for (var u = 0, c = pr(e, n, a, h), d = 0; d < l; d++) {
        var f = 0 === ia[d] || 1 === ia[d] ? 0.5 : 1;
        pr(t, i, r, ia[d]) < o ||
          (ia[d] < h ? (u += c < e ? f : -f) : (u += a < c ? f : -f));
      }
      return u;
    }
    f = 0 === ia[0] || 1 === ia[0] ? 0.5 : 1;
  ...
  function oa(t, e, i, n, r, a, o, s) {
    ...
    for (var c = 0, d = 0; d < 2; d++) {
      ...
      if (f + t > o) {
        ...
        u = a ? 1 : -1;
        p < 0 && (p = ta + p),
          ((p >= n && p <= r) || (p + ta >= n && p + ta <= r)) &&
            (p > Math.PI / 2 && p < 1.5 * Math.PI && (u = -u), (c += u));
      }
    }
    return c;
  }
  function sa(t, e, i, n, r) {
    for (var a, o, s = 0, l = 0, h = 0, u = 0, c = 0, d = 0; d < t.length; ) {
      var f = t[d++];
      switch (
        (f === Jr.M && d > 1 && (i || (s += Qr(l, h, u, c, n, r))),
        1 == d && ((u = l = t[d]), (c = h = t[d + 1])),
        f)
      ) {
        case Jr.M:
          (l = u = t[d++]), (h = c = t[d++]);
        ...
        case Jr.C:
          if (i) {
            if (
              Ur(l, h, t[d++], t[d++], t[d++], t[d++], t[d], t[d + 1], e, n, r)
            )
              return !0;
          } else
            s +=
              ra(l, h, t[d++], t[d++], t[d++], t[d++], t[d], t[d + 1], n, r) ||
              0;
          (l = t[d++]), (h = t[d++]);
          break;
        case Jr.Q:
  ...
  (ca.prototype = {
    ...
    brush: function(t, e) {
      ...
      h
        ...
        : c && (t.fillStyle = la.call(s, t)),
        u
          ? (t.strokeStyle = this._strokeGradient)
          : d && (t.strokeStyle = la.call(l, t));
      var f = n.lineDash,
        p = n.lineDashOffset,
        g = !!t.setLineDash,
      ...
      r.setScale(v[0], v[1]),
        this.__dirtyPath || (f && !g && a)
          ? (r.beginPath(t),
            f && !g && (r.setLineDash(f), r.setLineDashOffset(p)),
    ...
    attrKV: function(t, e) {
      "shape" === t
        ...
        : Gi.prototype.attrKV.call(this, t, e);
    },
    setShape: function(t, e) {
      var i = this.shape;
      if (i) {
        if (L(t)) for (var n in t) t.hasOwnProperty(n) && (i[n] = t[n]);
        else i[t] = e;
        this.dirty(!0);
      }
      return this;
    ...
    getLineScale: function() {
      var t = this.transform;
      return t && ha(t[0] - 1) > 1e-10 && ha(t[3] - 1) > 1e-10
        ? Math.sqrt(ha(t[0] * t[3] - t[2] * t[1]))
        : 1;
    },
  }),
  ...
  function Ia(t, e) {
    var i = (function(t) {
      ...
      for (e = 0; e < ma.length; e++)
        i = i.replace(new RegExp(ma[e], "g"), "|" + ma[e]);
      var n,
        r = i.split("|"),
        a = 0,
        o = 0,
  ...
  (Ca.prototype = {
    ...
    brush: function(t, e) {
      ...
      null != n && (n += ""),
        i.bind(t, this, e),
        Vi(n, i) &&
          (this.setTransform(t), Ai(this, t, n, i), this.restoreTransform(t));
    },
    getBoundingRect: function() {
      var t = this.style;
      if ((this.__dirty && Ii(t), !this._rect)) {
        ...
        if (
          ((i.x += t.x || 0),
          (i.y += t.y || 0),
          Ri(t.textStroke, t.textStrokeWidth))
        ) {
              ...
              for (var r = 0; r < i.length; r++) {
                ...
                if (
                  ...
                  for (var l = 0; l < Da.length; l++)
                    (Da[l][2] = n[Da[l][0]]), (n[Da[l][0]] = Da[l][1]);
                  e = !0;
                  break;
                }
              }
  ...
  var Ea = function(t, e) {
      for (var i = t.length, n = [], r = 0, a = 1; a < i; a++)
        r += nt(t[a - 1], t[a]);
      var o = r / 2;
      o = o < i ? i : o;
      for (a = 0; a < o; a++) {
        ...
        var p = d * d,
          g = d * p;
        n.push([
          Oa(s[0], f[0], l[0], h[0], d, p, g),
          Oa(s[1], f[1], l[1], h[1], d, p, g),
        ]);
      }
      return n;
    },
    Na = function(t, e, i, n) {
      ...
      for (d = 0, f = t.length; d < f; d++) {
        ...
        var y = J([], p, u),
          x = J([], p, c);
        n && (lt(y, y, o), st(y, y, s), lt(x, x, o), st(x, x, s)),
          l.push(y),
          l.push(x);
      }
  ...
  function Wa(t, e, i) {
    ...
    return null === n || null === r
      ? [
          (i ? cr : ur)(t.x1, t.cpx1, t.cpx2, t.x2, e),
          (i ? cr : ur)(t.y1, t.cpy1, t.cpy2, t.y2, e),
        ]
      : [
          (i ? gr : pr)(t.x1, t.cpx1, t.x2, e),
          (i ? gr : pr)(t.y1, t.cpy1, t.y2, e),
        ];
  }
  var Ga = ca.extend({
      type: "bezier-curve",
  ...
  (Ya.prototype = { constructor: Ya }), w(Ya, Ua);
  ...
  (Za.prototype = { constructor: Za }),
    w(Za, Ua),
    (ja.prototype.incremental = !0),
    (ja.prototype.clearDisplaybles = function() {
      (this._displayables = []),
        (this._temporaryDisplayables = []),
        (this._cursor = 0),
        this.dirty(),
  ...
  (ja.prototype.getBoundingRect = function() {
    if (!this._rect) {
      for (
        var t = new Ce(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0;
        e < this._displayables.length;
        e++
      ) {
        var i = this._displayables[e],
          n = i.getBoundingRect().clone();
        i.needLocalTransform() && n.applyTransform(i.getLocalTransform(Ka)),
          t.union(n);
      }
      this._rect = t;
    }
  ...
  function ro(t, e) {
    var i,
      ...
      r = t.height * n;
    return (
      (i = r <= t.width ? t.height : (r = t.width) / n),
      {
        x: t.x + t.width / 2 - r / 2,
  ...
  function so(t) {
    var e = t.shape,
      i = t.style.lineWidth;
    return (
      $a(2 * e.x1) === $a(2 * e.x2) && (e.x1 = e.x2 = lo(e.x1, i, !0)),
      $a(2 * e.y1) === $a(2 * e.y2) && (e.y1 = e.y2 = lo(e.y1, i, !0)),
      t
    );
  }
  function lo(t, e, i) {
  ...
  function co(t) {
    if (t.__hoverStlDirty) {
      var e = t.style.stroke,
        i = t.style.fill,
        n = t.__hoverStl;
      (n.fill = n.fill || (ho(i) ? uo(i) : null)),
        (n.stroke = n.stroke || (ho(e) ? uo(e) : null));
      var r = {};
    ...
    if (!t.__isHover) {
      if ((co(t), t.useHoverLayer)) t.__zr && t.__zr.addHover(t, t.__hoverStl);
        ...
        i &&
          ...
          i &&
            (Ao(e, e.insideOriginalTextPosition, i),
  ...
  function yo(t) {
    (this.__hoverSilentOnTouch && t.zrByTouch) ||
      (!this.__isEmphasis && go(this));
  }
  function xo(t) {
    (this.__hoverSilentOnTouch && t.zrByTouch) ||
      (!this.__isEmphasis && vo(this));
  }
  function _o() {
  ...
  function bo(t, e, i) {
    (t.__hoverSilentOnTouch = i && i.hoverSilentOnTouch),
      "group" === t.type
        ...
        : mo(t, e),
      t.on("mouseover", yo).on("mouseout", xo),
      t.on("emphasis", _o).on("normal", wo);
  }
  function Mo(t, e, i, n, r, a, o) {
    var s,
      l = (r = r || to).labelFetcher,
      h = r.labelDataIndex,
      u = r.labelDimIndex,
      c = i.getShallow("show"),
      d = n.getShallow("show");
    (c || d) &&
      ...
      null == s &&
        (s = k(r.defaultText) ? r.defaultText(h, r) : r.defaultText));
    var f = c ? s : null,
      p = d
        ? z(l ? l.getFormattedLabel(h, "emphasis", null, u) : null, s)
        : null;
    (null == f && null == p) || (So(t, i, a, r), So(e, n, o, r, !0)),
      (t.text = f),
      (e.text = p);
  }
  ...
  function To(t, e, i, n) {
    if ((i = i || to).isRectText) {
      ...
      null != a && (a *= Math.PI / 180),
        (t.textRotation = a),
        (t.textDistance = z(e.getShallow("distance"), n ? null : 5));
    }
    var o,
      s = e.ecModel,
  ...
  function Io(t, e, i, n, r, a) {
    if (
      ((i = (!r && i) || to),
      (t.textFill = Co(e.getShallow("color"), n) || i.color),
      (t.textStroke =
        Co(e.getShallow("textBorderColor"), n) || i.textBorderColor),
      (t.textStrokeWidth = z(
    ...
    (t.fontStyle = e.getShallow("fontStyle") || i.fontStyle),
      ...
      (a && n.disableBox) ||
        ((t.textBackgroundColor = Co(e.getShallow("backgroundColor"), n)),
        (t.textPadding = e.getShallow("padding")),
        (t.textBorderColor = Co(e.getShallow("borderColor"), n)),
  ...
  function Oo(t, e, i) {
    return (
      e && !M(e) && (e = kt.getLocalTransform(e)),
      i && (e = It([], e)),
      ot([], t, e)
    );
  }
  function Eo(t, e, i, n) {
    ...
    function o(t) {
      var e = { position: Q(t.position), rotation: t.rotation };
      return t.shape && (e.shape = v({}, t.shape)), e;
    }
  }
  function No(t, e, i) {
    var n = ((e = v({ rectHover: !0 }, e)).style = { strokeNoScale: !0 });
    if (((i = i || { x: -1, y: -1, width: 2, height: 2 }), t))
      return 0 === t.indexOf("image://")
        ? ((n.image = t.slice(8)), m(n, i), new qi(e))
        : io(t.replace("path://", ""), e, i, "center");
  }
  var Ro = (Object.freeze || Object)({
      ...
      subPixelOptimizeRect: function(t) {
        ...
        return (
          (e.x = lo(e.x, i, !0)),
          (e.y = lo(e.y, i, !0)),
          (e.width = Math.max(lo(n + a, i, !1) - e.x, 0 === a ? 0 : 1)),
          (e.height = Math.max(lo(r + o, i, !1) - e.y, 0 === o ? 0 : 1)),
          t
        );
      },
      subPixelOptimize: lo,
      ...
      clipRectByRect: function(t, e) {
        ...
        if (n >= i && a >= r)
          return { x: i, y: r, width: n - i, height: a - r };
      },
      createIcon: No,
      Group: Ae,
      Image: qi,
  ...
  (Go.prototype = {
    ...
    get: function(t, e) {
      return null == t
        ? this.option
        : qo(this.option, this.parsePath(t), !e && Xo(this, t));
    },
    ...
    getModel: function(t, e) {
      var i;
      return new Go(
        null == t ? this.option : qo(this.option, (t = this.parsePath(t))),
        (e = e || ((i = Xo(this, t)) && i.getModel(t))),
        this.ecModel
      );
    },
    isEmpty: function() {
  ...
  function ds(t, e) {
    var i = (t = P(t) ? { color: t, extraCssText: e } : t || {}).color,
      n = t.type;
    e = t.extraCssText;
    return i
      ? "subItem" === n
  ...
  function _s(t, e, i) {
    ...
    function o(i, r) {
      ...
      if (
        ...
        return (
          l(e, i[1]) ? (h[i[2]] = null) : l(e, i[2]) && (h[i[1]] = null), h
        );
      if (2 !== u && o) {
        if (o >= 2) return a;
    ...
    Ts = Go.extend({
      ...
      mergeDefaultAndTheme: function(t, e) {
        var i = this.layoutMode,
          n = i ? ws(t) : {};
        g(t, e.getTheme().get(this.mainType)),
          g(t, this.getDefaultOption()),
          i && _s(t, n, i);
      },
  ...
  Yn(Ts, { registerWhenExtend: !0 }),
    (Ms = {}),
    ((bs = Ts).registerSubTypeDefaulter = function(t, e) {
      (t = Hn(t)), (Ms[t.main] = e);
    }),
        ...
        if (t.length) {
          ...
          for (
            ...
            var u = l.pop(),
              c = s[u],
              d = !!h[u];
            d && (r.call(a, u, c.originalDeps.slice()), delete h[u]),
              S(c.successor, d ? p : f);
          }
          S(h, function() {
  ...
  var Ps = {
    cartesian2d: function(t, e, i, n) {
      ...
      (e.coordSysDims = ["x", "y"]),
        i.set("x", r),
        i.set("y", a),
        Ls(r) && (n.set("x", r), (e.firstCategoryDimIndex = 0)),
        Ls(a) && (n.set("y", a), (e.firstCategoryDimIndex = 1));
    },
    singleAxis: function(t, e, i, n) {
      var r = t.getReferringComponents("singleAxis")[0];
      (e.coordSysDims = ["single"]),
        i.set("single", r),
        Ls(r) && (n.set("single", r), (e.firstCategoryDimIndex = 0));
    },
    polar: function(t, e, i, n) {
      ...
      (e.coordSysDims = ["radius", "angle"]),
        i.set("radius", a),
        i.set("angle", o),
        Ls(a) && (n.set("radius", a), (e.firstCategoryDimIndex = 0)),
        Ls(o) && (n.set("angle", o), (e.firstCategoryDimIndex = 1));
    },
  ...
  function Hs(t) {
    (this.fromDataset = t.fromDataset),
      (this.data = t.data || (t.sourceFormat === Rs ? {} : [])),
      (this.sourceFormat = t.sourceFormat || Bs),
      (this.seriesLayoutBy = t.seriesLayoutBy || Fs),
  ...
  (Hs.seriesDataToSource = function(t) {
    return new Hs({ data: t, sourceFormat: E(t) ? zs : Os, fromDataset: !1 });
  }),
    qn(Hs);
  var Ws = En();
  function Gs(t) {
    ...
    var u = (function(t, e, i, n, r) {
        if (!t) return { dimensionsDefine: qs(r) };
        var a, o, s, l;
        if (e === Es)
          "auto" === n || null == n
            ? Xs(
      ...
      (c = (function(t, e, i, n, r, a) {
        ...
        if (o && null != d.get(u)) {
          var f = t.ecModel,
            p = Ws(f).datasetMap,
            g = e.uid + "_" + r,
            v = p.get(g) || p.set(g, { categoryWayDim: 1, valueWayDim: 0 });
          ...
          for (var m, y = 0; y < 5 && null == m; y++)
            Ys(i, n, r, a.dimensionsDefine, a.startIndex, y) || (m = y);
          if (null != m) {
            s.value = m;
  ...
  function qs(t) {
    if (t) {
      ...
      return T(t, function(t, i) {
        if (null == (t = v({}, L(t) ? t : { name: t })).name) return t;
  ...
  var Zs = "\0_ec_inner",
    js = Go.extend({
      init: function(t, e, i, n) {
        (i = i || {}),
          (this.option = null),
          (this._theme = new Go(i)),
          (this._optionManager = n);
      },
      setOption: function(t, e) {
        W(!(Zs in t), "please use chart.getOption()"),
          ...
          this.option && "recreate" !== t
            ...
            : function(t) {
                (t = t),
                  ...
                  (e = t),
                  (i = this._theme.option),
                  (n = e.color && !e.colorLayer),
                  S(i, function(t, i) {
                    ("colorLayer" === i && n) ||
                      Ts.hasClass(i) ||
                      ("object" == typeof t
      ...
      mergeOption: function(t) {
        var e = this.option,
          ...
          n = [];
        (Ws(this).datasetMap = Z()),
          S(t, function(t, i) {
            null != t &&
              (Ts.hasClass(i)
                ? i && n.push(i)
                : (e[i] = null == e[i] ? p(t) : g(e[i], t, !0)));
          }),
          Ts.topologicalTravel(
            n,
            Ts.getAllClassMainTypes(),
            function(n, r) {
              var a = In(t[n]),
                o = kn(i.get(n), a);
              (function(t) {
                ...
                bn(t, function(t, i) {
                  ...
                  bn(t, function(t, i) {
                    ...
                    if (Mn(r)) {
                      if (
                        ((a.name =
                          null != r.name ? r.name + "" : n ? n.name : Tn + i),
                        n)
                      )
                        a.id = n.id;
              ...
              (e[n] = []),
                    ...
                    if ((W(L(o) || a, "Empty component definition"), o)) {
                      ...
                      if (a && a instanceof l)
                        (a.name = t.keyInfo.name),
                          a.mergeOption(o, this),
                          a.optionUpdated(o, !1);
                      else {
                        var h = v(
                          { dependentModels: s, componentIndex: r },
                          t.keyInfo
                        );
                        v((a = new l(o, this, this, h)), h),
                          a.init(o, this, this, h),
                ...
                "series" === n && Ks(this, i.get("series"));
            },
            this
          ),
          (this._seriesIndicesMap = Z(
      ...
      getOption: function() {
        ...
        return (
          S(t, function(e, i) {
            if (Ts.hasClass(i)) {
              for (var n = (e = In(e)).length - 1; n >= 0; n--)
                Ln(e[n]) && e.splice(n, 1);
              t[i] = e;
            }
          }),
      ...
      findComponents: function(t) {
        var e,
          ...
          l =
            ...
            (n = s + "Id"),
            (r = s + "Name"),
            !(e = o) || (null == e[i] && null == e[n] && null == e[r])
              ? null
              : { mainType: s, index: e[i], id: e[n], name: e[r] }),
  ...
  sl.prototype = {
    ...
    setOption: function(t, e) {
      t &&
        S(In(t.series), function(t) {
          t && t.data && E(t.data) && X(t.data);
        }),
        (t = nl(t, !0));
      var i,
        n,
        r = this._optionBackup,
        a = function(t, e, i) {
          var n,
            r,
            a = [],
                ...
                if (Ts.hasClass(e)) {
                  ...
                  i[e] = rl(r, function(t) {
                    return t.option && t.exist
                      ? al(t.exist, t.option, !0)
                      : t.exist || t.option;
                  });
                } else i[e] = al(n, t, !0);
              }
            }),
            a.timelineOptions.length && (r.timelineOptions = a.timelineOptions),
            a.mediaList.length && (r.mediaList = a.mediaList),
            a.mediaDefault && (r.mediaDefault = a.mediaDefault))
          : (this._optionBackup = a);
    },
    mountOption: function(t) {
      var e = this._optionBackup;
      return (
        (this._timelineOptions = rl(e.timelineOptions, nl)),
        (this._mediaList = rl(e.mediaList, nl)),
        (this._mediaDefault = nl(e.mediaDefault)),
        (this._currentMediaIndices = []),
        nl(t ? e.baseOption : this._newBaseOption)
      );
    },
    ...
    getMediaOption: function(t) {
      ...
      for (var h = 0, u = a.length; h < u; h++)
        ll(a[h].query, n, r) && s.push(h);
      return (
        !s.length && o && (s = [-1]),
        s.length &&
          ((e = s),
          (i = this._currentMediaIndices),
          e.join(",") !== i.join(",")) &&
          (l = rl(s, function(t) {
    ...
    if (e)
      for (var i = 0, n = cl.length; i < n; i++) {
        ...
        a &&
          a[r] &&
          ((t[r] = t[r] || {}),
          t[r].normal ? g(t[r].normal, a[r]) : (t[r].normal = a[r]),
          (a[r] = null)),
          o &&
            o[r] &&
            ((t[r] = t[r] || {}),
            t[r].emphasis ? g(t[r].emphasis, o[r]) : (t[r].emphasis = o[r]),
            (o[r] = null));
      }
  }
  function fl(t, e, i) {
    if (t && t[e] && (t[e].normal || t[e].emphasis)) {
      var n = t[e].normal,
        r = t[e].emphasis;
      n &&
        (i ? ((t[e].normal = t[e].emphasis = null), m(t[e], n)) : (t[e] = n)),
        ...
        (function(t) {
          if (ul(t)) {
            dl(t),
              ...
              t.emphasis &&
                (gl(t.emphasis, "label"),
                gl(t.emphasis, "upperLabel"),
                gl(t.emphasis, "edgeLabel")),
              (i = t.markPoint) && (dl(i), vl(i)),
              (n = t.markLine) && (dl(n), vl(n));
            var e = t.markArea;
            e && vl(e);
            var i,
              n,
            ...
            if ("graph" === t.type) {
              ...
              if (a && !E(a)) for (var o = 0; o < a.length; o++) vl(a[o]);
              S(t.categories, function(t) {
                pl(t);
              });
            }
            if (r && !E(r)) for (o = 0; o < r.length; o++) vl(r[o]);
            ...
            if ((n = t.markLine) && n.data) {
              ...
              for (o = 0; o < l.length; o++)
                D(l[o]) ? (vl(l[o][0]), vl(l[o][1])) : vl(l[o]);
            }
            "gauge" === t.type
              ? (gl(t, "axisLabel"), gl(t, "title"), gl(t, "detail"))
              : "treemap" === t.type
              ? (fl(t.breadcrumb, "itemStyle"),
                S(t.levels, function(t) {
                  pl(t);
                }))
  ...
  var wl = [
    ...
    Ml = function(t, e) {
      xl(t, e),
        (t.series = In(t.series)),
        S(t.series, function(t) {
          if (L(t)) {
            var e = t.type;
            if (
              (("pie" !== e && "gauge" !== e) ||
    ...
    S(t, function(e, i) {
      var n = [],
        ...
        l = o.map(a, function(a, l, h) {
          var u,
            c,
            d = o.get(e.stackedDimension, h);
          if (isNaN(d)) return r;
          s ? (c = o.getRawIndex(h)) : (u = o.get(e.stackedByDimension, h));
          for (var f = NaN, p = i - 1; p >= 0; p--) {
            var g = t[p];
            if (
              (s || (c = g.data.rawIndexOf(g.stackedByDimension, u)), c >= 0)
            ) {
  ...
  function Tl(t, e) {
    ...
    n === zs && ((this._offset = 0), (this._dimSize = e), (this._data = i)),
      v(this, Cl[n === Es ? n + "_" + t.seriesLayoutBy : n]);
  }
  var Il = Tl.prototype;
  (Il.pure = !1),
    (Il.persistent = !0),
    (Il.getSource = function() {
      return this._source;
    });
  var Cl = {
    arrayRows_column: {
    ...
    objectRows: { pure: !0, count: Al, getItem: Dl, appendData: kl },
    keyedColumns: {
      pure: !0,
      count: function() {
    ...
    original: { count: Al, getItem: Dl, appendData: kl },
    typedArray: {
      persistent: !1,
      pure: !0,
      count: function() {
  ...
  var Ol = {
    ...
    original: function(t, e, i, n) {
      ...
      return (
        ...
        Nl(r instanceof Array ? r[n] : r, this._dimensionInfos[e])
      );
    },
  ...
  Hl.perform = function(t) {
    ...
    if (
      ...
      if (!n && (a || d < f)) {
        ...
        if (D(p)) for (var g = 0; g < p.length; g++) Gl(this, p[g], d, f, l, h);
  ...
  function Gl(t, e, i, n, r, a) {
    Wl.reset(i, n, r, a),
      ...
      t._callingProgress(
        { start: i, end: n, count: n - i, next: Wl.next },
        t.context
      );
  }
  (Hl.dirty = function() {
    ...
    Xl = Ts.extend({
      ...
      init: function(t, e, i, n) {
        (this.seriesIndex = this.componentIndex),
          (this.dataTask = Fl({ count: Yl, reset: Zl })),
      ...
      mergeDefaultAndTheme: function(t, e) {
        var i = this.layoutMode,
          n = i ? ws(t) : {},
          r = this.subType;
        Ts.hasClass(r) && (r += "Series"),
          g(t, e.getTheme().get(this.subType)),
          g(t, this.getDefaultOption()),
          Cn(t, "label", ["show"]),
      ...
      mergeOption: function(t, e) {
        ...
        Kl(n, this),
          ...
          (ql(this).dataBeforeProcessed = n),
          Ul(this);
      },
      fillDataTextStyle: function(t) {
        if (t && !E(t))
          for (var e = ["show"], i = 0; i < t.length; i++)
            t[i] && t[i].label && Cn(t[i], "label", e);
      },
      ...
      formatTooltip: function(t, e, i) {
        ...
        L(h) && h.colorStops && (h = (h.colorStops[0] || {}).color),
          (h = h || "transparent");
        var u =
            o > 1 || (l && !o)
              ? (function(i) {
                  ...
                  function s(t, i) {
                    ...
                    if (a && !1 !== a.otherDims.tooltip) {
                      var s = a.type,
                        l = ds({ color: h, type: "subItem" }),
                        u =
                          (n ? l + hs(a.displayName || "-") + ": " : "") +
                          hs(
                            "ordinal" === s
                              ? t + ""
                              : "time" === s
  ...
  function rh() {
    (this.group = new Ae()),
      (this.uid = Yo("viewChart")),
      (this.renderTask = Fl({ plan: lh, reset: hh })),
  ...
  function ph(t, e, i) {
    ...
    var d = function() {
      ...
      (s = null),
        (r = n - (d ? l : h) - t),
        clearTimeout(u),
        d ? (u = setTimeout(c, t)) : r >= 0 ? c() : (u = setTimeout(c, -r)),
        (l = n);
    };
    return (
      (d.clear = function() {
    ...
    mh = function(t, e) {
      ...
      if (i.get("show"))
        if (i.get("description"))
          t.setAttribute("aria-label", i.get("description"));
        else {
          var n = 0;
          ...
          if (!(n < 1)) {
            ...
            r = l
              ? u(c("general.withTitle"), { title: l })
              : c("general.withoutTitle");
            var h = [];
            (r += u(
              c(n > 1 ? "series.multiple.prefix" : "series.single.prefix"),
              { seriesCount: n }
            )),
              e.eachSeries(function(t, e) {
                if (e < s) {
                  ...
                  i = u((i = c(r ? o + "withName" : o + "withoutName")), {
                    ...
                    seriesType:
                      ((v = t.subType), vh.series.typeNames[v] || "自定义图"),
                  });
                  var l = t.getData();
                  (window.data = l),
                    l.count() > a
                      ? (i += u(c("data.partialData"), { displayCnt: a }))
                      : (i += c("data.allData"));
                  for (var d = [], f = 0; f < l.count(); f++)
                    if (f < a) {
                      var p = l.getName(f),
                        g = Rl(l, f);
                      d.push(
                        u(c(p ? "data.withName" : "data.withoutName"), {
                          name: p,
                          value: g,
                        })
                      );
                  ...
                  (i +=
                    d.join(c("data.separator.middle")) +
                    c("data.separator.end")),
                    h.push(i);
                }
                var v;
              }),
              (r +=
                h.join(c("series.multiple.separator.middle")) +
                c("series.multiple.separator.end")),
      ...
      function c(t) {
        var e = i.get(t);
        if (null == e) {
          for (var n = t.split("."), r = vh.aria, a = 0; a < n.length; ++a)
            r = r[n[a]];
          return r;
        }
        return e;
  ...
  (_h.restoreData = function(t, e) {
          ...
          n.reset &&
            (function(t, e, i, n, r) {
              ...
              e.createOnAllSeries
                ? n.eachRawSeries(l)
                : o
                ? n.eachRawSeriesByType(o, l)
                : s && s(n, r).each(l);
              function l(i) {
                var o = i.uid,
                  s =
                    a.get(o) ||
                    a.set(o, Fl({ plan: Ch, reset: Ah, count: Ph }));
                (s.context = {
                  model: i,
                  ecModel: n,
                  api: r,
            ...
            n.overallReset &&
              (function(t, e, i, n, r) {
                var a = (i.overallTask = i.overallTask || Fl({ reset: Mh }));
                a.context = {
                  ecModel: n,
                  api: r,
                ...
                function c(e) {
                  var i = e.uid,
                    n = o.get(i);
                  n ||
                    ((n = o.set(i, Fl({ reset: Sh, onDirty: Ih }))), a.dirty()),
                    (n.context = {
                      model: e,
                      overallProgress: h,
                      modifyOutputEnd: u,
    ...
    (_h.performDataProcessorTasks = function(t, e) {
      wh(this, this._dataProcessorHandlers, t, e, { block: !0 });
    }),
  ...
  Rh(Eh, js),
    Rh(Nh, Js),
    (Eh.eachSeriesByType = Eh.eachRawSeriesByType = function(t) {
      Oh = t;
    }),
  ...
  (Vh.categoryAxis.splitLine.show = !1),
    Ts.extend({
      type: "dataset",
      defaultOption: {
        seriesLayoutBy: Fs,
  ...
  var Hh = W,
    ...
    Zh = 3e3,
    jh = {
      PROCESSOR: { FILTER: Uh, STATISTIC: 5e3 },
      VISUAL: {
        LAYOUT: Yh,
        GLOBAL: 2e3,
        CHART: Zh,
  ...
  function eu(t, e, i) {
    ...
    (this._throttledZrFlush = ph(C(n.flush, n), 17)),
      (e = p(e)) && Ml(e, !0),
      (this._theme = e),
      (this._chartsViews = []),
      (this._chartsMap = {}),
      ...
      (this._componentsMap = {}),
      (this._coordSysMgr = new el());
    var r,
      a,
      o = (this._api =
        ((a = (r = this)._coordSysMgr),
        v(new Js(r), {
    ...
    Re(Mu, s),
      Re(_u, s),
      (this._scheduler = new xh(this, o, _u, Mu)),
      dt.call(this),
      (this._messageCenter = new tu()),
      this._initEvents(),
  ...
  (tu.prototype.on = Jh("on")),
    (tu.prototype.off = Jh("off")),
    (tu.prototype.one = Jh("one")),
    b(tu, dt);
  var iu = eu.prototype;
  function nu(t, e, i) {
    var n,
  ...
  (iu._onframe = function() {
    ...
    (iu.setOption = function(t, e, i) {
      var n;
      if (
        (qh(e) && ((i = e.lazyUpdate), (n = e.silent), (e = e.notMerge)),
        (this[Kh] = !0),
        !this._model || e)
      ) {
      ...
      this._model.setOption(t, wu),
        i
          ? ((this[$h] = { silent: n }), (this[Kh] = !1))
          : (au(this),
            ru.update.call(this),
            this._zr.flush(),
            (this[$h] = !1),
    ...
    (iu.getSvgDataUrl = function() {
      if (n.svgSupported) {
        var t = this._zr;
        return (
          S(t.storage.getDisplayList(), function(t) {
            t.stopAnimation(!0);
          }),
      ...
      if (n.canvasSupported) {
        ...
        if (Cu[e]) {
          ...
          return (
            Wh(h, function(t) {
              var e = new qi({
                style: { x: t.left * u - a, y: t.top * u - o, image: t.dom },
              });
              g.add(e);
            }),
    ...
    (iu.convertToPixel = A(nu, "convertToPixel")),
    (iu.convertFromPixel = A(nu, "convertFromPixel")),
    (iu.containPixel = function(t, e) {
      var i;
      return (
        S(
          (t = Rn(this._model, t)),
  ...
  var ru = {
    ...
    updateView: function(t) {
      var e = this._model;
      e &&
        (rh.markUpdateMethod(t, "updateView"),
        du(e),
        this._scheduler.performVisualTasks(e, t, { setDirty: !0 }),
        fu(this, this._model, this._api, t),
        gu(e, this._api));
    },
  ...
  function lu(t, e) {
    ...
    Wh(
      l,
      function(t) {
        ((u = (u = r.action(t, this._model, this._api)) || v({}, t)).type =
          a.event || u.type),
          c.push(u),
          d ? ou(this, s, t, "series") : o && ou(this, s, t, o.main, o.sub);
      },
      this
    ),
      "none" === s ||
        ...
        o ||
        (this[$h]
          ? (au(this), ru.update.call(this, t), (this[$h] = !1))
          : ru[s].call(this, t)),
      (u = h ? { type: a.event || i, escapeConnect: n, batch: c } : c[0]),
      (this[Kh] = !1),
  ...
  function cu(t, e, i, n) {
    ...
    function u(t) {
      ...
      if (!h) {
        var u = Xh(t.type);
        (h = new (r ? Jl.getClass(u.main, u.sub) : rh.getClass(u.sub))()).init(
          i,
          l
        ),
          (o[e] = h),
  ...
  function pu(t, e, i, r, a) {
    ...
    e.eachSeries(function(e) {
      ...
      var n = i.renderTask;
      s.updatePayload(n, r),
        a && a.get(e.uid) && n.dirty(),
        (o |= n.perform(s.getPerformArgs(n))),
      ...
      qh(e) || (e = { silent: !!e }),
        yu[t.type] &&
          ...
          (this[Kh]
            ...
            : (lu.call(this, t, e.silent),
              e.flush
                ? this._zr.flush(!0)
                : !1 !== e.flush &&
                  n.browser.weChat &&
                  this._throttledZrFlush(),
              hu.call(this, e.silent),
              uu.call(this, e.silent)));
    }),
  ...
  function zu(t, e, i) {
    ...
    var n = qh(t) ? t.type : [t, (t = { event: e })][0];
    (t.event = (t.event || n).toLowerCase()),
      (e = t.event),
      Hh(Qh.test(n) && Qh.test(e)),
      yu[n] || (yu[n] = { action: i, actionInfo: t }),
      (xu[e] = n);
  }
  function Fu(t, e) {
    Hu(Mu, t, e, Yh, "layout");
  ...
  Vu(2e3, gh),
    ...
    Wu("default", function(t, e) {
      ...
      var i = new Fa({
        ...
        n = new qa({
          shape: { startAngle: -yh / 2, endAngle: -yh / 2 + 0.1, r: 10 },
      ...
      n
        .animateShape(!0)
        .when(1e3, { endAngle: (3 * yh) / 2 })
        .start("circularInOut"),
        n
          .animateShape(!0)
          .when(1e3, { startAngle: (3 * yh) / 2 })
          .delay(300)
          .start("circularInOut");
      var a = new Ae();
      return (
    ...
    zu({ type: "highlight", event: "highlight", update: "highlight" }, j),
    zu({ type: "downplay", event: "downplay", update: "downplay" }, j),
    Nu("light", zh),
    Nu("dark", Vh);
  function Uu(t) {
    return t;
  ...
  function Yu(t, e, i, n, r) {
    (this._old = t),
      (this._new = e),
      (this._oldKeyGetter = i || Uu),
      (this._newKeyGetter = n || Uu),
      (this.context = r);
  }
  ...
  Yu.prototype = {
    ...
    execute: function() {
      var t = this._old,
        ...
        r = [];
      for (
        Zu(t, {}, n, "_oldKeyGetter", this),
          Zu(e, i, r, "_newKeyGetter", this),
          a = 0;
        a < t.length;
        a++
      ) {
  ...
  var ac = function(t, e) {
      ...
      (this.dimensions = n),
        ...
        (this._dimensionsSummary = (function(t) {
          var e = {},
            i = (e.encode = {}),
            n = Z(),
            r = [],
          ...
          S(t.dimensions, function(e) {
            var o,
              s = t.getDimensionInfo(e),
              l = s.coordDim;
            if (l) {
              var h = i[l];
              i.hasOwnProperty(l) || (h = i[l] = []),
                (h[s.coordDimIndex] = e),
                s.isExtraCoord ||
                  (n.set(l, 1),
                  "ordinal" !== (o = s.type) && "time" !== o && (r[0] = e)),
  ...
  function uc(t, e) {
    var i = t._idList[e];
    return (
      null == i && (i = sc(t, t._idDimIdx, e)), null == i && (i = $u + e), i
    );
  }
  function cc(t) {
    return D(t) || (t = [t]), t;
  ...
  function dc(t, e) {
    ...
    for (var r = (n._storage = {}), a = t._storage, o = 0; o < i.length; o++) {
      ...
      a[s] &&
        (_(e, s) >= 0
          ? ((r[s] = fc(a[s])), (n._rawExtent[s] = pc()), (n._extent[s] = null))
          : (r[s] = a[s]));
    }
    return n;
  }
  function fc(t) {
    for (var e, i, n = new Array(t.length), r = 0; r < t.length; r++)
      n[r] =
        ((e = t[r]),
        (i = void 0),
  ...
  (oc.type = "list"),
    ...
    (oc.initData = function(t, e, i) {
      (Hs.isInstance(t) || M(t)) && (t = new Tl(t, this.dimensions.length)),
        (this._rawData = t),
        (this._storage = {}),
        (this._indices = null),
        (this._nameList = e || []),
        ...
        (this.defaultDimValueGetter =
          Ol[this._rawData.getSource().sourceFormat]),
    ...
    (oc._initDataFromProvider = function(t, e) {
      if (!(t >= e)) {
        for (
          ...
          c[(D = o[g])] || (c[D] = pc());
          var v = l[D];
          0 === v.otherDims.itemName && (i = this._nameDimIdx = g),
            0 === v.otherDims.itemId && (this._idDimIdx = g);
          var m = Qu[v.type];
          a[D] || (a[D] = []);
          var y = a[D][p];
          if (y && y.length < n) {
            for (
              var x = new m(Math.min(e - p * n, n)), _ = 0;
              _ < y.length;
              _++
            )
              x[_] = y[_];
          ...
          for (var w = f * n; w < e; w += n)
            a[D].push(new m(Math.min(e - w, n)));
        ...
        !r.persistent && r.clean && r.clean(),
          ...
          (this._extent = {}),
          S((M = (b = this)._invertedIndicesMap), function(t, e) {
    ...
    (oc.indicesOfNearest = function(t, e, i) {
      ...
      null == i && (i = 1 / 0);
      for (
        var r = Number.MAX_VALUE, a = -1, o = 0, s = this.count();
        o < s;
        o++
      ) {
        ...
        l <= i &&
          h <= r &&
          ((h < r || (l >= 0 && a < 0)) && ((r = h), (a = l), (n.length = 0)),
          n.push(o));
      }
      return n;
    }),
    (oc.getRawIndex = lc),
    (oc.getRawDataItem = function(t) {
    ...
    (oc.each = function(t, e, i, n) {
      if (this._count) {
        "function" == typeof t && ((n = i), (i = e), (e = t), (t = [])),
          (i = i || n || this);
        for (
          var r = (t = T(cc(t), this.getDimension, this)).length, a = 0;
          a < this.count();
          a++
        )
          switch (r) {
    ...
    (oc.filterSelf = function(t, e, i, n) {
      if (this._count) {
        "function" == typeof t && ((n = i), (i = e), (e = t), (t = [])),
          (i = i || n || this),
          (t = T(cc(t), this.getDimension, this));
        for (
          var r = this.count(),
            a = new (ec(this))(r),
            o = [],
        ...
        return (
          ...
          (this._count = l),
          (this._extent = {}),
          (this.getRawIndex = this._indices ? hc : lc),
          this
        );
      }
    }),
          ...
          if (!u)
            if (1 === n)
              for (v = 0; v < r; v++) {
                ...
                (((w = this._getFast(s, M)) >= l && w <= h) || isNaN(w)) &&
                  (a[o++] = M);
              }
            else
              for (v = 0; v < r; v++) {
                ...
                for (M = this.getRawIndex(v), f = 0; f < n; f++) {
                  var T = e[f];
                  ((w = this._getFast(i, M)) < t[T][0] || w > t[T][1]) &&
                    (S = !1);
                }
  ...
  function vc(t, e, i) {
    Hs.isInstance(e) || (e = Hs.seriesDataToSource(e)),
      (i = i || {}),
      (t = (t || []).slice());
    for (
      ...
      var u = (n[h] = v({}, L(n[h]) ? n[h] : { name: n[h] })),
        c = u.name,
        d = (s[h] = { otherDims: {} });
      null != c &&
        null == a.get(c) &&
        ((d.name = d.displayName = c), a.set(c, h)),
        null != u.type && (d.type = u.type),
    ...
    function g(t, e, i) {
      null != ju.get(e)
        ? (t.otherDims[e] = i)
        : ((t.coordDim = e), (t.coordDimIndex = i), o.set(e, !0));
    }
    S(t, function(t, e) {
      var i, n, a;
      if (P(t)) (i = t), (t = {});
    ...
    for (var w = y || "value", b = 0; b < l; b++) {
      null == (d = s[b] = s[b] || {}).coordDim &&
        ((d.coordDim = mc(w, o, _)),
        (d.coordDimIndex = 0),
        (!y || x <= 0) && (d.isExtraCoord = !0),
        x--),
        null == d.name && (d.name = mc(d.coordDim, a)),
        null == d.type && Us(e, b, d.name) && (d.type = "ordinal");
    }
    return s;
  }
  function mc(t, e, i) {
  ...
  (oc.setItemGraphicEl = function(t, e) {
    ...
    (oc.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"]),
    (oc.CHANGABLE_METHODS = ["filterSelf", "selectRange"]);
  var yc = function(t, e) {
  ...
  function wc(t, e, i) {
    ...
    var s,
      l,
      h = yc(t, { coordDimensions: n, generateCoord: i.generateCoord });
    o &&
      S(h, function(t, e) {
        var i = t.coordDim,
  ...
  var Ac = eo({
    ...
    buildPath: function(t, e, i) {
      ...
      "none" !== e.symbolType &&
        (r || (r = Cc[(n = "rect")]),
        Ic[n](e.x, e.y, e.width, e.height, r.shape),
  ...
  function kc(t, e, i, n, r, a, o) {
    ...
    return (
      ...
      ((s =
        0 === t.indexOf("image://")
          ? no(t.slice(8), new Ce(e, i, n, r), o ? "center" : "cover")
          : 0 === t.indexOf("path://")
          ? io(t.slice(7), {}, new Ce(e, i, n, r), o ? "center" : "cover")
          : new Ac({
  ...
  (Lc._createSymbol = function(t, e, i, n, r) {
    ...
    a.attr({ z2: 100, culling: !0, scale: Ec(n) }),
      (a.drift = Nc),
      (this._symbolType = t),
      this.add(a);
  }),
    ...
    (Lc.updateData = function(t, e, i) {
      ...
      if (o) {
        ...
        ((l = this.childAt(0)).silent = !1), Po(l, { scale: Ec(a) }, r, e);
      }
      if ((this._updateCommon(t, e, a, i), o)) {
        var l = this.childAt(0),
          h = i && i.fadeIn,
          u = { scale: l.scale.slice() };
        h && (u.style = { opacity: l.style.opacity }),
          (l.scale = [0, 0]),
          h && (l.style.opacity = 0),
          Lo(l, u, r, e);
      }
  ...
  (Lc._updateCommon = function(t, e, i, n) {
    ...
    if (!n || t.hasItemOption) {
      ...
      (s = g.getModel(Rc).getItemStyle(["color"])),
        (l = g.getModel(Bc).getItemStyle()),
        (h = g.getShallow("symbolRotate")),
        (u = g.getShallow("symbolOffset")),
        (c = g.getModel(zc)),
        (d = g.getModel(Fc)),
        (f = g.getShallow("hoverAnimation")),
        (p = g.getShallow("cursor"));
    } else l = v({}, l);
    var m = r.style;
    r.attr("rotation", ((h || 0) * Math.PI) / 180 || 0),
      u && r.attr("position", [Ko(u[0], i[0]), Ko(u[1], i[1])]),
      p && r.attr("cursor", p),
      r.setColor(o, n && n.symbolInnerColor),
      r.setStyle(s);
    ...
    var x = t.getItemVisual(e, "liftZ"),
      _ = r.__z2Origin;
    null != x
      ? null == _ && ((r.__z2Origin = r.z2), (r.z2 += x))
      : null != _ && ((r.z2 = _), (r.__z2Origin = null));
      ...
      var M = function() {
          if (!this.incremental) {
            ...
            this.animateTo(
              {
                scale: [
                  Math.max(1.1 * b[0], b[0] + 3),
                  Math.max(1.1 * b[1], b[1] + 3 * t),
                ],
              },
              400,
              "elasticOut"
        ...
        S = function() {
          this.incremental || this.animateTo({ scale: b }, 400, "elasticOut");
        };
      r.on("mouseover", M)
        .on("mouseout", S)
        .on("emphasis", M)
  ...
  function Gc(t) {
    return null == t || L(t) || (t = { isIgnore: t }), t || {};
  }
  function qc(t) {
    var e = t.hostModel;
    return {
    ...
    r || i.removeAll(),
      t
        ...
        .update(function(s, l) {
          ...
          Wc(t, u, s, e)
            ? (h
                ? (h.updateData(t, s, o), Po(h, { position: u }, n))
                : (h = new a(t, s)).attr("position", u),
              i.add(h),
          ...
          for (var c = 0, d = i, f = 0; f < n; f++) {
            ...
            if (d === i) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]);
              ...
              Kc(Qc, g),
                ...
                Kc(Jc, p),
                (Jc[v] = p[v] - m),
                t.bezierCurveTo(Qc[0], Qc[1], Jc[0], Jc[1], p[0], p[1]);
  ...
  function ld(t, e, i, n) {
    return "polar" === t.type
      ? (function(t, e, i, n) {
          ...
          return (
            e &&
              ((l.shape.endAngle = -o[0] * s),
              Lo(l, { shape: { endAngle: -o[1] * s } }, n)),
            l
          );
        })(t, e, i, n)
      : (function(t, e, i, n) {
          ...
          if (i) (s -= 0.5), (h += 0.5), (l -= 0.5), (u += 0.5);
          else {
            var c = n.get("lineStyle.width") || 2,
              d = n.get("clipOverflow") ? c / 2 : Math.max(h, u);
            o ? ((l -= d), (u += 2 * d)) : ((s -= d), (h += 2 * d));
          }
          var f = new Fa({ shape: { x: s, y: l, width: h, height: u } });
          return (
            e &&
              ((f.shape[o ? "width" : "height"] = 0),
              Lo(f, { shape: { width: h, height: u } }, n)),
            f
          );
        })(t, e, i, n);
  }
        ...
        (!r ||
          !(function(t, e) {
            ...
            for (
              ...
              if (1.5 * Pc.getSymbolSize(e, o)[t.isHorizontal() ? 1 : 0] > n)
                return !1;
            return !0;
          })(a, e))
      ) {
  ...
  rh.extend({
    ...
    render: function(t, e, i) {
      ...
      b &&
        ...
        r.add(p);
      var M = !h && t.get("step");
      d && u.type === n.type && M === this._step
        ? (v && !f
            ? (f = this._newPolygon(l, x, n, g))
            : f && !v && (p.remove(f), (f = this._polygon = null)),
          p.setClipPath(ld(n, !1, !1, t)),
          _ && c.updateData(a, { isIgnore: w, clipShape: ld(n, !1, !0, t) }),
          a.eachItemGraphicEl(function(t) {
            t.stopAnimation(!0);
          }),
          (ad(this._stackedOnPoints, x) && ad(this._points, l)) ||
            (g
              ? this._updateAnimation(a, x, n, i, M, y)
              : (M && ((l = hd(l, n, M)), (x = hd(x, n, M))),
                d.setShape({ points: l }),
                f && f.setShape({ points: l, stackedOnPoints: x }))))
        : (_ && c.updateData(a, { isIgnore: w, clipShape: ld(n, !1, !0, t) }),
          M && ((l = hd(l, n, M)), (x = hd(x, n, M))),
          (d = this._newPolyline(l, n, g)),
          v && (f = this._newPolygon(l, x, n, g)),
          p.setClipPath(ld(n, !0, !1, t)));
      var I =
        (function(t, e) {
      ...
      d.useStyle(
        m(o.getLineStyle(), { fill: "none", stroke: I, lineJoin: "bevel" })
      );
      var C = t.get("smooth");
      if (
        ((C = od(t.get("smooth"))),
        ...
        var A = a.getCalculationInfo("stackedOnSeries"),
          D = 0;
        f.useStyle(
          m(s.getAreaStyle(), { fill: I, opacity: 0.7, lineJoin: "bevel" })
        ),
          A && (D = od(A.get("smooth"))),
          f.setShape({
            smooth: C,
    ...
    _newPolyline: function(t) {
      ...
      return (
        ...
        (e = new nd({ shape: { points: t }, silent: !0, z2: 10 })),
    ...
    _newPolygon: function(t, e) {
      ...
      return (
        ...
        (i = new rd({ shape: { points: t, stackedOnPoints: e }, silent: !0 })),
    ...
    _updateAnimation: function(t, e, i, n, r, a) {
          ...
          for (
            ...
            switch (x.cmd) {
              ...
              case "+":
                ...
                h.push(
                  r.dataToPoint([
                    e.get(v.dataDimsForPoint[0], M),
                    e.get(v.dataDimsForPoint[1], M),
                  ])
                ),
              ...
              case "-":
                ...
                S !== M
                  ? (h.push(t.getItemLayout(M)),
                    u.push(
                      a.dataToPoint([
                        t.get(m.dataDimsForPoint[0], M),
                        t.get(m.dataDimsForPoint[1], M),
                      ])
                    ),
                    c.push(i[M]),
                    d.push(Uc(m, a, t, M)),
      ...
      r &&
        ((u = hd(h.current, i, r)),
        (c = hd(h.stackedOnCurrent, i, r)),
        (d = hd(h.next, i, r)),
        (f = hd(h.stackedOnNext, i, r))),
        (o.shape.__points = h.current),
        (o.shape.points = u),
        Po(o, { shape: { points: d } }, l),
        s &&
          (s.setShape({ points: u, stackedOnPoints: c }),
          Po(s, { shape: { points: d, stackedOnPoints: f } }, l));
      for (var p = [], g = h.status, v = 0; v < g.length; v++) {
        if ("=" === g[v].cmd) {
          var m = t.getItemGraphicEl(g[v].idx1);
          m && p.push({ el: m, ptIdx: v });
        }
      }
      o.animators &&
        o.animators.length &&
                ...
                a.hasItemOption || h
                  ? function(e, i) {
                      ...
                      if (e.hasItemOption) {
                        ...
                        null != o && e.setItemVisual(i, "symbol", o),
                          null != l && e.setItemVisual(i, "symbolSize", l),
                          null != h &&
                            e.setItemVisual(i, "symbolKeepAspect", h);
                      }
                    }
                  : null,
            };
  ...
  (gd.prototype.parse = function(t) {
    ...
    (gd.prototype.getLabel = null),
    Wn(gd),
    Yn(gd, { registerWhenExtend: !0 }),
  ...
  var _d = gd.prototype,
    wd = gd.extend({
      ...
      contain: function(t) {
        return (
          (t = this.parse(t)),
          _d.contain.call(this, t) && null != this._ordinalMeta.categories[t]
        );
      },
  ...
  var Id = $o,
    Cd = gd.extend({
      ...
      unionExtent: function(t) {
        ...
        t[0] < e[0] && (e[0] = t[0]),
          t[1] > e[1] && (e[1] = t[1]),
          Cd.prototype.setExtent.call(this, e[0], e[1]);
      },
      ...
      getTicks: function() {
        return (function(t, e, i, n) {
          ...
          for (
            var a = i[0];
            a <= i[1] && (r.push(a), (a = bd(a + t, n)) !== r[r.length - 1]);
        ...
        if (isFinite(r)) {
          ...
          var a = (function(t, e, i, n) {
            ...
            return (
              Td(
                (r.niceTickExtent = [
                  bd(Math.ceil(t[0] / o) * o, s),
                  bd(Math.floor(t[1] / o) * o, s),
                ]),
                t
              ),
              r
      ...
      niceExtent: function(t) {
        ...
        t.fixMin || (e[0] = Id(Math.floor(e[0] / r) * r)),
          t.fixMax || (e[1] = Id(Math.ceil(e[1] / r) * r));
      },
    });
  Cd.create = function() {
    return new Cd();
      ...
      (function(t) {
        ...
        return (
          S(e, function(t, e) {
            ...
            var d = -c / 2;
            S(n, function(t, n) {
              (i[e][n] = i[e][n] || { offset: d, width: t.width }),
                (d += t.width * (1 + o));
            });
          }),
          i
  ...
  var Nd = Cd.prototype,
    ...
    zd = Cd.extend({
      ...
      niceExtent: function(t) {
        ...
        t.fixMin || (e[0] = $o(Bd(e[0] / n) * n)),
          t.fixMax || (e[1] = $o(Rd(e[1] / n) * n));
      },
      niceTicks: function(t, e, i) {
        t = t || 10;
        var n = this._extent,
        ...
        var u = this.getSetting("useUTC")
          ...
          c = [
            Math.round(Rd((n[0] - u) / h) * h + u),
            Math.round(Bd((n[1] - u) / h) * h + u),
          ];
        Td(c, n),
          (this._stepLvl = l),
          (this._interval = h),
  ...
  zd.create = function(t) {
    return new zd({ useUTC: t.ecModel.get("useUTC") });
  };
  var Vd = gd.prototype,
    Hd = Cd.prototype,
    Wd = Qo,
    ...
    Zd = gd.extend({
      ...
      getTicks: function() {
        var t = this._originalScale,
          ...
          i = t.getExtent();
        return T(
          Hd.getTicks.call(this),
          function(n) {
            var r = $o(Ud(this.base, n));
            return (
              (r = n === e[0] && t.__fixMin ? jd(r, i[0]) : r),
              (r = n === e[1] && t.__fixMax ? jd(r, i[1]) : r)
            );
          },
          this
        );
      ...
      getExtent: function() {
        ...
        var i = this._originalScale,
          n = i.getExtent();
        return (
          i.__fixMin && (e[0] = jd(e[0], n[0])),
          i.__fixMax && (e[1] = jd(e[1], n[1])),
          e
        );
      },
      unionExtent: function(t) {
  ...
  function Kd(t, e) {
    ...
    "ordinal" === a
      ...
      : (D((n = e.get("boundaryGap"))) || (n = [n || 0, n || 0]),
        "boolean" == typeof n[0] && (n = [0, 0]),
        (n[0] = Ko(n[0], 1)),
        (n[1] = Ko(n[1], 1)),
        (r = u[1] - u[0] || Math.abs(u[0]))),
      null == o && (o = "ordinal" === a ? (i ? 0 : NaN) : u[0] - n[0] * r),
      null == s && (s = "ordinal" === a ? (i ? i - 1 : NaN) : u[1] + n[1] * r),
      "dataMin" === o
        ? (o = u[0])
        : "function" == typeof o && (o = o({ min: u[0], max: u[1] })),
      "dataMax" === s
        ? (s = u[1])
        ...
        var p = Pd(f),
          g = (function(t, e, i, n) {
            ...
            var h = s + l,
              u = e - t,
              c = u / (1 - (s + l) / a) - u;
            return { min: (t -= c * (s / h)), max: (e += c * (l / h)) };
          })(o, s, e, p);
        (o = g.min), (s = g.max);
      }
    }
      ...
      ? (function(t, e) {
          ...
          if (k(a)) i = ff(t, a, !0);
            ...
            (n = s.labelCategoryInterval),
              (i = T(s.labels, function(t) {
                return t.tickValue;
              }));
          } else i = df(t, (n = a), !0);
          return cf(r, a, { ticks: i, tickCategoryInterval: n });
        })(t, e)
        ...
        : ((n =
            "auto" === a
              ? (function(t) {
                  ...
                  return null != e
                    ? e
                    : (af(t).autoInterval = t.calculateCategoryInterval());
                })(t)
              : a),
          (i = df(t, n))),
      cf(r, a, { labels: i, labelCategoryInterval: n }))
    );
  }
  function hf(t, e) {
  ...
  function df(t, e, i) {
    ...
    function p(t) {
      s.push(
        i ? t : { formattedLabel: n(t), rawLabel: r.getLabel(t), tickValue: t }
      );
    }
  ...
  vf.prototype = {
    ...
    getTicksCoords: function(t) {
      ...
      return (
        (function(t, e, i, n, r) {
          ...
          var o,
            s = t.getExtent();
          if (1 === a) (e[0].coord = s[0]), (o = e[1] = { coord: s[0] });
          else {
            ...
            S(e, function(t) {
              ...
              (o = { coord: e[a - 1].coord + l }),
              e.push(o);
          }
          var h = s[0] > s[1];
          u(e[0].coord, s[0]) && (r ? (e[0].coord = s[0]) : e.shift());
          r && u(s[0], e[0].coord) && e.unshift({ coord: s[0] });
          u(s[1], o.coord) && (r ? (o.coord = s[1]) : e.pop());
          r && u(o.coord, s[1]) && e.push({ coord: s[1] });
          function u(t, e) {
            return h ? t > e : t < e;
          }
        })(this, n, i.tickCategoryInterval, r, t.clamp),
        n
      );
    },
    ...
    calculateCategoryInterval: function() {
      return (function(t) {
        ...
        for (
          var l = a[0],
            h = t.dataToCoord(l + 1) - t.dataToCoord(l),
            u = Math.abs(h * Math.cos(n)),
            c = Math.abs(h * Math.sin(n)),
            d = 0,
            f = 0;
          l <= a[1];
          l += s
        ...
        return (
          ...
          w > x
            ? (x = w)
            : ((_.lastTickCount = o), (_.lastAutoInterval = x)),
          x
        );
      })(this);
    },
  ...
  (_f.categoryAxis = g(
    ...
    (_f.valueAxis = g({ boundaryGap: [0, 0], splitNumber: 5 }, xf)),
    (_f.timeAxis = m(
      { scale: !0, min: "dataMin", max: "dataMax" },
      _f.valueAxis
    )),
    (_f.logAxis = m({ scale: !0, logBase: 10 }, _f.valueAxis));
        ...
        e.extend({
          ...
          mergeDefaultAndTheme: function(e, n) {
            var a = this.layoutMode,
              o = a ? ws(e) : {};
            g(e, n.getTheme().get(r + "Axis")),
              g(e, this.getDefaultOption()),
              (e.type = i(t, e)),
              a && _s(e, o, a);
          },
          optionUpdated: function() {
            "category" === this.option.type &&
              (this.__ordinalMeta = vd.createByAxisModel(this));
          },
          ...
          defaultOption: (function(t, e) {
            for (var i = t[0], n = 1, r = t.length; n < r; n++)
              i = g(i, t[n], e);
            return i;
          })([{}, _f[r + "Axis"], n], !0),
        });
  ...
  (Df.type = "grid"),
                  ...
                  for (var x = 0; x < r; x += y) {
                    var _ = m(n ? n[x] : o[0] + x),
                      ...
                      b =
                        ...
                        (d = c.width),
                        (f = c.height),
                        (p = d * Math.cos(u) + f * Math.sin(u)),
                        (g = d * Math.sin(u) + f * Math.cos(u)),
                        new Ce(c.x, c.y, p, g));
                    s ? s.union(b) : (s = b);
                  }
                  return s;
    ...
    (Df._initCartesian = function(t, e, i) {
      var n = { left: !1, right: !1, top: !1, bottom: !1 },
        ...
        a = { x: 0, y: 0 };
      if (
        (e.eachComponent("xAxis", o("x"), this),
    ...
    (Df.getTooltipAxes = function(t) {
      var e = [],
        i = [];
      return (
        S(this.getCartesians(), function(n) {
  ...
  (Af.create = function(t, e) {
    ...
    (Af.dimensions = Af.prototype.dimensions = rf.prototype.dimensions),
    el.register("cartesian2d", Af);
  var Nf = Math.PI;
  function Rf(t) {
  ...
  var Bf = function(t, e) {
    (this.opt = e),
      ...
      (this.group = new Ae());
    var i = new Ae({ position: e.position.slice(), rotation: e.rotation });
            ...
            S(
              ...
              function(e, i) {
                if ("none" !== s[i] && null != s[i]) {
                  ...
                  n.attr({ rotation: e.rotate, position: l, silent: !0 }),
                    this.group.add(n);
                }
              },
              this
      ...
      axisTickLabel: function() {
        var t = this.axisModel,
          ...
          n = (function(t, e, i) {
            var n = e.axis;
            if (
              !B(i.axisLabelShow, e.get("axisLabel.show")) ||
              n.scale.isBlank()
            )
              return;
            ...
            return (
              S(o, function(o, s) {
                ...
                h &&
                  h[f] &&
                  h[f].textStyle &&
                  (v = new Go(h[f].textStyle, r, e.ecModel));
        ...
        !(function(t, e, i) {
          ...
          !1 === n
            ? (Hf(a), Hf(h))
            : Wf(a, o) && (n ? (Hf(o), Hf(u)) : (Hf(a), Hf(h)));
          !1 === r
            ? (Hf(s), Hf(c))
            : Wf(l, s) && (r ? (Hf(l), Hf(d)) : (Hf(s), Hf(c)));
        })(t, n, i);
      },
      axisName: function() {
        var t = this.opt,
          ...
          var n,
            ...
            c = [
              "start" === a
                ...
                ? h[1] + u * l
                : (h[0] + h[1]) / 2,
              Gf(a) ? t.labelOffset + o * l : 0,
            ],
            d = e.get("nameRotate");
          null != d && (d = (d * Nf) / 180),
            Gf(a)
              ? (n = Ff(t.rotation, null != d ? d : t.rotation, o))
              : ((n = (function(t, e, i, n) {
                  var r,
                    a,
                    o = Jo(i - t.rotation),
                    ...
                    : ((a = "middle"),
                      (r =
                        o < 1.5 * Nf && o > Nf / 2
                          ...
                          ? "right"
                          : "left"));
                  return { rotation: o, textAlign: r, textVerticalAlign: a };
                })(t, a, d || 0, h)),
                null != (r = t.axisNameAvailableWidth) &&
                  ((r = Math.abs(r / Math.sin(n.rotation))),
                  !isFinite(r) && (r = null)));
          var f = s.getFont(),
            ...
            y =
              null != g && null != m
                ? gs(i, m, f, g, { minChar: 2, placeholder: p.placeholder })
                : i,
            x = e.get("tooltip", !0),
            _ = e.mainType,
  ...
  function Wf(t, e, i) {
    ...
    if (n && r) {
      ...
      return (
        ...
        r.applyTransform(bt([], a, e.getLocalTransform())),
        n.intersect(r)
      );
    }
  }
        ...
        qf(i.getCoordinateSystems(), function(i) {
          if (i.axisPointerEnabled) {
            ...
            if (
              ...
              (c || d) && qf(f.baseAxes, Xf(g, !d || "cross", c)),
                d && qf(f.otherAxes, Xf(g, "cross", !1));
            }
          }
          function g(n, s, h) {
            ...
            if (d && ("auto" !== d || n || jf(c))) {
              ...
              var x = (function(t, e) {
                for (var i = e.model, n = e.dim, r = 0; r < t.length; r++) {
                  ...
                  if (
                    Yf(a[n + "AxisId"], i.id) ||
                    Yf(a[n + "AxisIndex"], i.componentIndex) ||
                    Yf(a[n + "AxisName"], i.name)
                  )
                    return r;
                }
              })(a, h);
              if (null != x) {
                var _ = o[x] || (o[x] = { axesInfo: {} });
                (_.axesInfo[g] = y),
                  (_.mapper = a[x].mapper),
                  (y.linkGroup = _);
              }
        ...
        (function(t, e) {
          e.eachSeries(function(e) {
            ...
            i &&
              ...
              qf(t.coordSysAxesInfo[Kf(i.model)], function(t) {
                var n = t.axis;
                i.getAxis(n.dim) === n &&
  ...
  function ep(t, e, i) {
    ...
    (a.position = ["y" === h ? p[d[l]] : c[0], "x" === h ? p[d[l]] : c[3]]),
    ...
    (a.labelDirection = a.tickDirection = a.nameDirection = {
      ...
      B(i.labelInside, e.get("axisLabel.inside")) &&
      ...
      render: function(t, e, i, n) {
        ...
        if (
          ...
          S(ip, s.add, s),
            ...
            Eo(r, this._axisGroup, t),
            rp.superCall(this, "render", t, e, i, n);
        }
      },
      remove: function() {
      ...
      _splitArea: function(t, e) {
        ...
        if (!i.scale.isBlank()) {
          var n = t.getModel("splitArea"),
            ...
            s = i.getTicksCoords({ tickModel: n, clamp: !0 });
          if (s.length) {
            var l = a.length,
            ...
            for (d = 1; d < s.length; d++) {
              var v,
                ...
                x,
                _,
                w = i.toGlobalCoord(s[d].coord);
              i.isHorizontal()
                ? ((v = p), (y = o.y), (x = w - v), (_ = o.height), (p = v + x))
                : ((v = o.x), (y = p), (x = o.width), (p = y + (_ = w - y)));
  ...
  rp.extend({ type: "xAxis" }),
    rp.extend({ type: "yAxis" }),
    qu({
      type: "grid",
      render: function(t, e) {
        this.group.removeAll(),
          t.get("show") &&
            this.group.add(
              new Fa({
                ...
                style: m({ fill: t.get("backgroundColor") }, t.getItemStyle()),
                silent: !0,
                z2: -1,
              })
            );
    ...
    Vu(cd("line", "circle", "line")),
    Fu(dd("line")),
    Bu(
      jh.PROCESSOR.STATISTIC,
      (function(t) {
        return {
          seriesType: t,
          modifyOutputEnd: !0,
          reset: function(t, e, i) {
            ...
            if ("cartesian2d" === a.type && r) {
              ...
              c > 1 &&
                ...
                o &&
                  t.setData(n.downSample(n.mapDimension(l.dim), 1 / c, o, pd)));
            }
          },
        };
      })("line")
  ...
  (sp.stopEffectAnimation = function() {
    ...
    (sp.startEffectAnimation = function(t) {
      for (
        var e = t.symbolType, i = t.color, n = this.childAt(1), r = 0;
        r < 3;
        r++
      ) {
    ...
    (sp.updateData = function(t, e) {
      ...
      var u = {};
      if (
        ((u.showEffectOn = i.get("showEffectOn")),
        (u.rippleScale = r.get("rippleEffect.scale")),
        (u.brushType = r.get("rippleEffect.brushType")),
        (u.period = 1e3 * r.get("rippleEffect.period")),
        (u.effectOffset = e / t.count()),
        (u.z = r.getShallow("z") || 0),
        (u.zlevel = r.getShallow("zlevel") || 0),
        (u.symbolType = a),
        (u.color = s),
        this.off("mouseover")
          .off("mouseout")
        ...
        this._effectCfg
          ? this.updateEffectAnimation(u)
          : this.startEffectAnimation(u),
          (this._effectCfg = u);
      else {
    ...
    Xu({
      ...
      updateTransform: function(t, e, i) {
        ...
        this.group.dirty();
        var r = dd().reset(t);
        r.progress && r.progress({ start: 0, end: n.count() }, n),
      ...
      _updateGroupTransform: function(t) {
        ...
        n &&
          ...
          ((this.group.transform =
            ((e = n.getRoamTransform()), wt((i = xt()), e), i)),
  ...
  function yp(t, e, i) {
    this.root,
      ...
      (this._nodes = []),
      (this.hostModel = t),
      (this.levelModels = T(e || [], function(e) {
  ...
  function xp(t, e, i) {
    if (t && _(e, t.type) >= 0) {
      var n = i.getData().tree.root,
        r = t.targetNode;
      if (r && n.contains(r)) return { node: r };
      var a = t.targetNodeId;
      if (null != a && (r = n.getNodeById(a))) return { node: r };
    }
  }
  (mp.prototype = {
    constructor: mp,
    ...
    getModel: function(t) {
      if (!(this.dataIndex < 0)) {
        ...
        return (
          ...
          n.getModel(t, (r || e || i.hostModel).getModel(t))
        );
      }
    },
    ...
    (yp.createTree = function(t, e, i) {
      ...
      var o,
        s,
        l,
        h = yc(r, { coordDimensions: ["value"], dimensionsCount: a }),
        u = new ac(h, e);
      return (
        u.initData(r),
        (s = (o = { mainData: u, struct: n, structAttr: "tree" }).mainData),
        (l = o.datas) || ((l = { main: s }), (o.datasAttr = { main: "data" })),
        (o.datas = o.mainData = null),
        gp(s, l, o),
        lp(l, function(t) {
        ...
        s.wrapMethod("cloneShallow", A(fp, o)),
        lp(s.CHANGABLE_METHODS, function(t) {
  ...
  function Mp(t, e, i) {
    ...
    var r = new Ca({ z2: bp, silent: t.getModel("label").get("silent") });
    function a() {
  ...
  (Sp.updateData = function(t, e, i, n, r) {
    ...
    "normal" === i
      ? (h = c)
      : (h = g(o.getModel(i + ".itemStyle").getItemStyle(), c));
    (h = m({ lineJoin: "bevel", fill: h.fill || u }, h)),
      t
        ? (a.setShape(l),
          (a.shape.r = s.r0),
          Po(a, { shape: { r: s.r } }, n, e.dataIndex),
          a.useStyle(h))
        : ("object" == typeof h.fill && h.fill.type) ||
          ("object" == typeof a.style.fill && a.style.fill.type)
        ? (Po(a, { shape: l }, n), a.useStyle(h))
        : Po(a, { shape: l, style: h }, n),
          ...
          (e.node === i
            ...
            : ((n = i),
              ...
              (a === _p.SELF
                ? n === r
                : a === _p.ANCESTOR
                ? n === r || n.isAncestorOf(r)
                : n === r || n.isDescendantOf(r))
                ? i.piece.childAt(0).trigger("highlight")
                : t !== _p.NONE && i.piece.childAt(0).trigger("downplay")));
      });
    }),
    ...
    (Sp._updateLabel = function(t, e, i) {
      ...
      var d,
        ...
        y = M("align");
      "outside" === v
        ? ((d = l.r + m), (y = f > Math.PI / 2 ? "right" : "left"))
        : y && "center" !== y
        ? "left" === y
          ? ((d = l.r0 + m), f > Math.PI / 2 && (y = "right"))
          : "right" === y && ((d = l.r - m), f > Math.PI / 2 && (y = "left"))
                ...
                if (n && n.piece)
                  i
                    ? (n.piece.updateData(!1, i, "normal", t, e),
                      a.setItemGraphicEl(i.dataIndex, n.piece))
                    : (function(t) {
                        if (!t) return;
        ...
        (function(i, n) {
          if (n.depth > 0) {
            r.virtualPiece
              ...
              : ((r.virtualPiece = new Mp(i, t, e)), l.add(r.virtualPiece)),
            ...
            r.virtualPiece &&
              (l.remove(r.virtualPiece), (r.virtualPiece = null));
        })(o, s),
  ...
  zu({ type: Tp, update: "updateView" }, function(t, e) {
    e.eachComponent(
  ...
  zu({ type: Ip, update: "updateView" }, function(t, e) {
    e.eachComponent(
      { mainType: "series", subType: "sunburst", query: t },
      function(e, i) {
        var n = xp(t, [Ip], e);
  ...
  zu({ type: "sunburstUnhighlight", update: "updateView" }, function(t, e) {
    e.eachComponent(
      { mainType: "series", subType: "sunburst", query: t },
      function(e, i) {
        t.unhighlight = !0;
              ...
              if (t) {
                ...
                if (t !== f) {
                  ...
                  var a = t.depth - g - (_ ? -1 : 1),
                    ...
                    c = h + b * (a + 1),
                    p = t.getModel();
                  null != p.get("r0") && (u = Ko(p.get("r0"), o / 2)),
                    null != p.get("r") && (c = Ko(p.get("r"), o / 2)),
                    t.setLayout({
                      angle: r,
                      startAngle: e,
                      endAngle: i,
  ...
  var Lp = function(t) {
    (this.name = t || ""),
      (this.cx = 0),
      (this.cy = 0),
      (this._radiusAxis = new kp()),
      (this._angleAxis = new Pp()),
  ...
  Lp.prototype = {
    ...
    pointToCoord: function(t) {
      ...
      (e /= s), (i /= s);
      for (
        var l = (Math.atan2(-i, e) / Math.PI) * 180, h = l < a ? 1 : -1;
        l < a || l > o;
  ...
  function Vp(t, e, i) {
    ...
    return { x1: n[0], y1: n[1], x2: r[0], y2: r[1] };
  }
  function Hp(t) {
  ...
  $f.extend({
    ...
    _axisLine: function(t, e, i, n) {
      var r = t.getModel("axisLine.lineStyle"),
        a = new Aa({
          shape: { cx: e.cx, cy: e.cy, r: n[Hp(e)] },
    ...
    _axisTick: function(t, e, i, n) {
      var r = t.getModel("axisTick"),
        ...
        o = n[Hp(e)],
        s = T(i, function(t) {
          return new Va({ shape: Vp(e, [o, o + a], t.coord) });
        });
      this.group.add(
        ao(s, {
      ...
      S(
        ...
        function(i, r) {
          var l = o,
            ...
            f = e.cy,
            p =
              Math.abs(c[0] - d) / u < 0.3
                ? "center"
                : c[0] > d
                ? "left"
                : "right",
            g =
              Math.abs(c[1] - f) / u < 0.3
                ? "middle"
                : c[1] > f
                ? "top"
                : "bottom";
          a &&
            a[h] &&
            a[h].textStyle &&
            (l = new Go(a[h].textStyle, o, o.ecModel));
          var v = new Ca({ silent: !0 });
          this.group.add(v),
            So(v.style, l, {
              x: c[0],
              y: c[1],
    ...
    _splitLine: function(t, e, i, n) {
      ...
      for (var s = [], l = 0; l < i.length; l++) {
        var h = o++ % a.length;
        (s[h] = s[h] || []), s[h].push(new Va({ shape: Vp(e, n, i[l].coord) }));
      }
      for (l = 0; l < s.length; l++)
        this.group.add(
          ao(s[l], {
            style: m({ stroke: a[l % a.length] }, r.getLineStyle()),
            silent: !0,
            z: t.get("z"),
          })
        );
    ...
    _splitArea: function(t, e, i, n) {
      if (i.length) {
        ...
        for (f = 0; f < s.length; f++)
          this.group.add(
            ao(s[f], {
              style: m({ fill: a[f % a.length] }, r.getAreaStyle()),
              silent: !0,
            })
          );
      }
  ...
  $f.extend({
    ...
    _splitLine: function(t, e, i, n, r) {
      ...
      for (var l = [], h = 0; h < r.length; h++) {
        ...
        (l[u] = l[u] || []),
          l[u].push(
            new Aa({ shape: { cx: e.cx, cy: e.cy, r: r[h].coord }, silent: !0 })
          );
      }
      for (h = 0; h < l.length; h++)
        this.group.add(
          ao(l[h], {
            style: m({ stroke: o[h % o.length], fill: null }, a.getLineStyle()),
            silent: !0,
          })
        );
    },
    _splitArea: function(t, e, i, n, r) {
      if (r.length) {
        ...
        for (u = 0; u < l.length; u++)
          this.group.add(
            ao(l[u], {
              style: m({ fill: o[u % o.length] }, a.getAreaStyle()),
              silent: !0,
            })
          );
      }
      ...
      if (t.involveSeries) {
        var o = (function(t, e) {
            var i = e.axis,
              ...
              s = -1;
            return (
              Xp(e.seriesModels, function(e, l) {
                var h,
                  u,
          ...
          s = o.payloadBatch,
          l = o.snapToValue;
        s[0] && null == r.seriesIndex && v(r, s[0]),
          !n && t.snap && a.containData(l) && null != l && (e = l),
          i.showPointer(t, e, s, r),
          i.showTooltip(t, o, l);
    ...
    if (!n.node) {
      ...
      Jp(r).records || (Jp(r).records = {}),
        (function(t, e) {
              ...
              var r = (function(t) {
                var e = { showTip: [], hideTip: [] },
                  i = function(n) {
                    ...
                    r
                      ? r.push(n)
                      : ((n.dispatchAction = i), t.dispatchAction(n));
                  };
          ...
          (Jp(t).initialized = !0),
            i("click", A(ng, "click")),
            i("mousemove", A(ng, "mousemove")),
            i("globalout", ig);
        })(r, e),
        ((Jp(r).records[t] || (Jp(r).records[t] = {})).handler = i);
    }
  }
  function ig(t, e, i) {
  ...
  var ag = qu({
      ...
      remove: function(t, e) {
        rg(e.getZr(), "axisPointer"),
          ag.superApply(this._model, "remove", arguments);
      },
      dispose: function(t, e) {
  ...
  function ug(t, e, i, n) {
    (function t(e, i) {
      ...
      ((og(i).lastProp = n), e ? Po(i, n, t) : (i.stopAnimation(), i.attr(n)));
  }
  function cg(t, e) {
  ...
  function gg(t, e, i, n, r) {
    ...
    (g && "auto" !== g) || (g = e.get("axisLine.lineStyle.color")),
      (t.label = {
        shape: { x: 0, y: 0, width: c, height: d, r: o.get("borderRadius") },
        position: u.slice(),
        style: {
          text: a,
          textFont: l,
  ...
  (hg.prototype = {
    ...
    _renderHandle: function(t) {
      if (!this._dragging && this.updateHandleTransform) {
        ...
        if (!a.get("show") || !o || "hide" === o)
          return r && n.remove(r), void (this._handle = null);
        this._handle ||
          ((e = !0),
          (r = this._handle = No(a.get("icon"), {
            cursor: "move",
            draggable: !0,
          ...
          (function(t, e, i, n) {
            ...
            if (r) {
              ...
              if (r[dh] !== i || o !== n) {
                ...
                ((r = t[e] = ph(a, i, "debounce" === n))[ch] = a),
                  (r[fh] = n),
                  (r[dh] = i);
              }
            }
          })(this, "_doDispatchAxisPointer", a.get("throttle") || 0, "fixRate"),
    ...
    _moveHandleToValue: function(t, e) {
      ug(
        ...
        this._handle,
        dg(this.getHandleTransform(t, this._axisModel, this._axisPointerModel))
      );
    },
  ...
  var xg = hg.extend({
    ...
    getHandleTransform: function(t, e, i) {
      var n = ep(e.axis.grid.model, e, { labelInside: !1 });
      return (
    ...
    updateHandleTransform: function(t, e, i, n) {
      var r = i.axis,
        ...
        h = t.position;
      (h[l] += e[l]),
        (h[l] = Math.min(o[1], h[l])),
        (h[l] = Math.max(o[0], h[l]));
      var u = (s[1] + s[0]) / 2,
        c = [u, u];
      c[l] = h[l];
      return {
  ...
  var wg = {
    line: function(t, e, i, n) {
      ...
      return so({ shape: r, style: n }), { type: "Line", shape: r };
    },
    shadow: function(t, e, i, n) {
      var r,
        a,
        o,
        s = Math.max(1, t.getBandWidth()),
        l = i[1] - i[0];
      return {
        type: "Rect",
        shape:
          ...
          (a = [s, l]),
          (o = bg(t)),
          { x: r[(o = o || 0)], y: r[1 - o], width: a[o], height: a[1 - o] }),
      };
    },
  };
  function bg(t) {
  ...
  $f.registerAxisPointerClass("CartesianAxisPointer", xg),
    Ru(function(t) {
      if (t) {
        ...
        if (s) {
          Qp(r) &&
            (r = (function(t, e) {
              var i,
                n = [],
                r = t.seriesIndex;
              if (null == r || !(i = e.getSeriesByIndex(r)))
                return { point: [] };
              var a = i.getData(),
                o = On(a, t);
              if (null == o || o < 0 || D(o)) return { point: [] };
              ...
              return { point: n, el: s };
            })({ seriesIndex: a.seriesIndex, dataIndex: a.dataIndex }, e)
              .point);
          var l = Qp(r),
            h = a.axesInfo,
            u = s.axesInfo,
            ...
            f = {},
            p = { list: [], map: {} },
            g = { showPointer: Up(jp, f), showTooltip: Up(Kp, p) };
          ...
          return (
            Xp(u, function(t, e) {
              ...
              i &&
                !f[e] &&
                Xp(i.axesInfo, function(e, n) {
                  var r = f[n];
                  if (e !== t && r) {
                    var a = r.value;
                    i.mapper &&
                      (a = t.axis.scale.parse(i.mapper(a, $p(e), $p(t)))),
                      (v[t.key] = a);
                  }
                });
            }),
            ...
            (function(t, e, i) {
              ...
              Xp(t, function(t, e) {
                ...
                "show" === i.status &&
                  Xp(i.seriesDataIndices, function(t) {
  ...
  var Mg = hg.extend({
    makeElOption: function(t, e, i, n, r) {
      ...
      o = a[
        "dataTo" +
          ((s = a.dim), s ? s.charAt(0).toUpperCase() + s.substr(1) : s)
      ](e);
      var u = n.get("type");
      if (u && "none" !== u) {
        var c = pg(n),
      ...
      var f = (function(t, e, i, n, r) {
        ...
        if ("radius" === a.dim) {
          ...
          var v = n.cx,
            m = n.cy;
          (h =
            Math.abs(l[0] - v) / g < 0.3
              ? "center"
              : l[0] > v
              ? "left"
              : "right"),
            (u =
              Math.abs(l[1] - m) / g < 0.3
                ? "middle"
                : l[1] > m
                ? "top"
                : "bottom");
  ...
  $f.registerAxisPointerClass("PolarAxisPointer", Mg),
    Fu(
      A(function(t, e, i) {
        var n = i.getWidth(),
          r = i.getHeight(),
          ...
          o = (function(t, e) {
            ...
            S(t, function(t, e) {
              ...
              i[Dp(a)] = l;
              var u = Ap(t);
              h[u] || l.autoWidthCount++,
                (h[u] = h[u] || { width: 0, maxWidth: 0 });
            ...
            return (
              S(i, function(t, e) {
                ...
                var d = -c / 2;
                S(i, function(t, i) {
                  (n[e][i] = n[e][i] || { offset: d, width: t.width }),
                    (d += t.width * (1 + o));
                });
              }),
              n
        ...
        e.eachSeriesByType(
          ...
          function(t) {
            if ("polar" === t.coordinateSystem.type) {
              ...
              a[l] = a[l] || [];
              for (
                var y = e.mapDimension(d.dim),
                  x = e.mapDimension(s.dim),
                  _ = xc(e, y),
                  w = d.getExtent()[0],
                  b = 0,
                  M = e.count();
                ...
                if (!isNaN(S)) {
                  ...
                  if (
                    (_ &&
                      (a[l][T] || (a[l][T] = { p: w, n: w }), (P = a[l][T][k])),
                    "radius" === d.dim)
                  ) {
                    var L = d.dataToRadius(S) - w,
                      O = s.dataToAngle(T);
                    Math.abs(L) < v && (L = (L < 0 ? -1 : 1) * v),
                      (I = P),
                      (C = P + L),
                      (D = (A = O - u) - c),
                      _ && (a[l][T][k] = C);
    ...
    (t.dispose = function(t) {
      "string" == typeof t ? (t = Iu[t]) : t instanceof eu || (t = Eu(t)),
        t instanceof eu && !t.isDisposed() && t.dispose();
    }),
    (t.getInstanceByDom = Eu),
    (t.getInstanceById = function(t) {
      return Iu[t];
    }),
    (t.registerTheme = Nu),
    (t.registerPreprocessor = Ru),
    (t.registerProcessor = Bu),
    ...
    (t.registerLayout = Fu),
    (t.registerVisual = Vu),
    (t.registerLoading = Wu),
    (t.extendComponentModel = Gu),
    (t.extendComponentView = qu),
    (t.extendSeriesModel = function(t) {
      return Xl.extend(t);
    }),
    (t.extendChartView = Xu),
...
class CircularAudioWave {
  constructor(t, e = {}) {
    ...
    if (
        ...
        series: [
          {
            ...
            lineStyle: {
              color: {
                colorStops: [
                  { offset: 0, color:  `rgba(${this.Color},1)` },
                  { offset:0, color:  `rgba(${this.Color},1)` },
                ],
              },
              shadowColor: `rgba(${this.Color},0.5)`,
              shadowBlur: 15,
              width:0.7,
              
            },
            zlevel: 2,
            data: Array.apply(null, { length: 361 }).map(Function.call, (t) => [
              this.minChartValue,
              t,
            ]),
            silent: !0,
          ...
          },
          {
            ...
            data: [0],
            symbolSize: 100,
            rippleEffect: { period: 3, scale: 2.5 },
            itemStyle: {
              color: {
                type: "radial",
                colorStops: [
                  { offset: 0, color:  `rgba(${this.Color},1)` },
                  { offset: 1, color: `rgba(${this.Color},0.2)` },
                ],
              },
            },
            silent: !0,
      ...
      for (let t = 0; t < 5; t++)
        e[0].children[0].children.push({ name: "-", children: [{ name: "" }] }),
          ...
          series: [
            {
              ...
              itemStyle: { borderColor: "#2E2733", borderWidth: 2 },
              levels: [
                {},
                { r0: 0, r: 40 },
                { r0: 40, r: 105 },
                {
                  ...
                  label: { rotate: "tangential", fontSize: 10, color: t[0] },
                },
                {
                  r0: 140,
                  r: 145,
                  itemStyle: { shadowBlur: 80, shadowColor: t[0], color: t[0] },
                  label: {
                    position: "outside",
                    textShadowBlur: 5,
                    textShadowColor: "#333",
  ...
  loadAudio(t) {
    (this.filePath = t), this._setupAudioNodes(), this._setupOfflineContext();
  ...
  _init() {
    this.chart.setOption(this.chartOption, !0),
      (this._debouncedDraw = this._debounce(
        this._drawAnimation.bind(this),
        25
      ));
      this.loaded("success")
  }
  presetOption() {
    "sunburst" !== this.opts.mode &&
      ((this.chartOption.series[0].animation = !1),
      (this.chartOption.series[2].rippleEffect.period = 150 / this.bpm));
  }
  play() {
    this.sourceNode && this.sourceNode.buffer
      ? ((this.playing = !0),
        this.presetOption(),
  ...
  _setupOfflineContext() {
    ...
    (t.type = "lowpass"),
      t.settar,
      t.frequency.setValueAtTime(150, 0),
      t.Q.setValueAtTime(1, 0),
      this.offlineSource.connect(t);
    let e = this.offlineContext.createBiquadFilter();
    (e.type = "highpass"),
      e.frequency.setValueAtTime(100, 0),
      e.Q.setValueAtTime(1, 0),
      t.connect(e),
      e.connect(this.offlineContext.destination);
  }
  _drawAnimation() {
  ...
  _draw(t) {
    if (this.playing) {
      ...
      (this.chartOption.series[0].data = e.data),
        e.maxR > this.lastMaxR
          ? (this.lastMaxR = e.maxR + 4)
          : this.playing
          ? (this.lastMaxR -= 2)
        ...
        "sunburst" !== this.opts.mode &&
          (this.chartOption.series[1].data = Array.apply(null, {
            length: 361,
          }).map(Function.call, (t) => [this.lastMaxR, t])),
        this.chart.setOption(this.chartOption, !0),
        this.tick++;
    }
  }
  _generateWaveData(t) {
    ...
    if ("sunburst" !== this.opts.mode) {
      for (let r = 0; r <= 360; r++) {
        var n =
          ((t[r] - 0) * (this.maxChartValue - this.minChartValue)) / 255 +
          this.minChartValue;
        n > i && (i = n), e.push([n, r]);
      }
      e.push([e[0][0], 360]);
      ...
      e.forEach((e) => {
        e.children.forEach((e) => {
          e.children.forEach((e) => {
            ...
            (e.children[0].name = Array.apply(null, { length: n })
              .map(Function.call, (t) => "")
              .join(" ")),
              i++;
          });
  ...
  _getBPM(t) {
    ...
    for (let n = 0; n < e; n++) {
      ...
      for (let i = 22050 * n; i < 22050 * (n + 1); i++) {
        ...
        (!e || n > e.volume) && (e = { position: i, volume: n });
      }
      i.push(e);
    }
    i.sort((t, e) => e.volume - t.volume),
      (i = i.splice(0, 0.5 * i.length)).sort((t, e) => t.position - e.position);
    let n = [];
    i.forEach((t, e) => {
      for (let r = 1; e + r < i.length && r < 10; r++) {
        let a = { bpm: 2646e3 / (i[e + r].position - t.position), count: 1 };
        for (; a.bpm < 90; ) a.bpm *= 2;
        for (; a.bpm > 180; ) a.bpm /= 2;
        (a.bpm = Math.round(a.bpm)),
          n.some((t) => (t.bpm === a.bpm ? t.count++ : 0)) || n.push(a);
      }
    });
